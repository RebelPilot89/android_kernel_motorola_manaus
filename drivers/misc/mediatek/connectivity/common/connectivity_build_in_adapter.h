 ...
 ******************************************************************************/
	...
	defined(CONFIG_MACH_MT6753) || defined(CONFIG_MACH_MT6739) ||          \
	defined(CONFIG_MACH_MT6755) || defined(CONFIG_MACH_MT6757) ||          \
	defined(CONFIG_MACH_MT6758) || defined(CONFIG_MACH_MT6759) ||          \
	defined(CONFIG_MACH_MT6763) || defined(CONFIG_MACH_MT6775) ||          \
	defined(CONFIG_MACH_MT6797) || defined(CONFIG_MACH_MT6799) ||          \
	defined(CONFIG_MACH_MT6580) || defined(CONFIG_MACH_MT6765) ||          \
	defined(CONFIG_MACH_MT6761) || defined(CONFIG_MACH_MT3967) ||          \
	defined(CONFIG_MACH_MT6771) || defined(CONFIG_MACH_MT6879) ||          \
	defined(CONFIG_MACH_KIBOPLUS) || defined(CONFIG_MACH_ELBRUS)
...
int connectivity_export_mmc_io_rw_direct(struct mmc_card *card, int write,
					 unsigned int fn, unsigned int addr,
					 u8 in, u8 *out);
...
#define KERNEL_event_trace_printk(ip, fmt, args...)                            \
	do {                                                                   \
		...
		if (__builtin_constant_p(fmt)) {                               \
			static const char *trace_printk_fmt __used __section(  \
				"__trace_printk_fmt") =                        \
