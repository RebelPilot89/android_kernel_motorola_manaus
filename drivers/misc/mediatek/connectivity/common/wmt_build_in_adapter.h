...
#include "../../include/mt-plat/mtk_wcn_cmb_stub.h"
...
struct wmt_platform_dbg_bridge {
	ssize_t (*write_cb)(struct file *filep, const char __user *buffer,
			    size_t count, loff_t *f_pos);
	ssize_t (*read_cb)(struct file *filep, char __user *buffer,
			   size_t count, loff_t *f_pos);
};
