...
void gps_dl_hw_dep_cfg_dsp_mem(enum dsp_ctrl_enum ctrl)
{
	...
	case GPS_L1_DSP_ENTER_DSLEEP:
		...
		GDL_HW_SET_GPS_ENTRY(GPS_RGU_ON_GPS_L1_DSPPRAM_SLP_EN_RGU_GPS_L1_PRAM_HWCTL_SLP, 0x3FF);
	...
	case GPS_L1_DSP_ENTER_DSTOP:
		...
		break;
	case GPS_L1_DSP_OFF:
		GDL_HW_SET_GPS_ENTRY(GPS_RGU_ON_GPS_L1_DSPPRAM_PDN_EN_RGU_GPS_L1_PRAM_HWCTL_PDN, 0x3FF);
