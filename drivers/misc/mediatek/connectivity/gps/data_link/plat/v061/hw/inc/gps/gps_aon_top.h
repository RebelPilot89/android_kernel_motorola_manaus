...
#define GPS_AON_TOP_DSLEEP_CTL_ADDR                            (GPS_AON_TOP_BASE + 0x108)
#define GPS_AON_TOP_WAKEUP_CTL_ADDR                            (GPS_AON_TOP_BASE + 0x110)
#define GPS_AON_TOP_TCXO_MS_H_ADDR                             (GPS_AON_TOP_BASE + 0x114)
#define GPS_AON_TOP_TCXO_MS_L_ADDR                             (GPS_AON_TOP_BASE + 0x118)
