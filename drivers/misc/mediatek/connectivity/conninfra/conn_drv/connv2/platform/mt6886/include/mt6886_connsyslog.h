...
#ifndef MT6886_CONNSYSLOG_H
#define MT6886_CONNSYSLOG_H

#include "../../../debug_utility/include/connsys_debug_utility.h"
#include "../../../debug_utility/connsyslog/connsyslog_hw_config.h"
...
static struct connlog_emi_config g_connsyslog_config[CONN_DEBUG_TYPE_END] = {
	/* Wi-Fi config */
	{ CONNLOG_EMI_OFFSET_WIFI,
	  CONNLOG_EMI_SIZE_WIFI,
	  { { CONNLOG_EMI_BLOCK_WIFI }, { CONNLOG_EMI_BLOCK_WIFI_MCU } } },
	{ CONNLOG_EMI_OFFSET_BT,
	  CONNLOG_EMI_SIZE_BT,
	  { { CONNLOG_EMI_BLOCK_BT }, { CONNLOG_EMI_BLOCK_BT_MCU } } },
};

#endif /* MT6886_CONNSYSLOG_H */
