...
extern void vcp_aed_reset_inplace(enum vcp_excep_id type, enum vcp_core_id id);
extern void vcp_get_log(enum vcp_core_id id);
extern char *vcp_pickup_log_for_aee(void);
extern void aed_vcp_exception_api(const int *log, int log_size, const int *phy,
...
#define c0_m vcp_c0_m
#define c0_t1_m vcp_c0_t1_m
#define c1_m vcp_c1_m
#define c1_t1_m vcp_c1_t1_m
