...
#if defined(CONFIG_PM_WAKELOCKS) || !__has_include(<linux/wakelock.h>)
#define CAM_USE_PM_WAKELOCKS 1
#include <linux/pm_wakeup.h>
#else
#define CAM_USE_PM_WAKELOCKS 0
...
#ifndef CONFIG_OF
const struct ISR_TABLE DIP_IRQ_CB_TBL[DIP_IRQ_TYPE_AMOUNT] = { { NULL, 0,
								 "DIP_A" } };

#else
/* int number is got from kernel api */

const struct ISR_TABLE DIP_IRQ_CB_TBL[DIP_IRQ_TYPE_AMOUNT] = { { DIP_Irq_DIP_A,
								 0, "dip" } };
...
const struct Dip_Init_Array DIP_INIT_ARY[DIP_INIT_ARRAY_COUNT] = {
	{ 0x1110, 0xffffffff }, { 0x1114, 0xffffffff }, { 0x1118, 0xffffffff },
	{ 0x111C, 0xffffffff }, { 0x1120, 0xffffffff }, { 0x1124, 0xffffffff },
	{ 0x1128, 0xffffffff }, { 0x112C, 0x1 },	{ 0x10A0, 0x80000000 },
	{ 0x10B0, 0x0 },	{ 0x10C0, 0x0 },	{ 0x10D0, 0x0 },
	{ 0x10E0, 0x0 },	{ 0x10F0, 0x0 },	{ 0x1204, 0x11 },
	{ 0x121C, 0x11 },	{ 0x1228, 0x11 },	{ 0x1234, 0x11 },
	{ 0x1240, 0x11 },	{ 0x124C, 0x11 },	{ 0x1258, 0x11 },
	{ 0x1264, 0x11 },	{ 0x1270, 0x11 },	{ 0x127C, 0x11 },
	{ 0x1288, 0x11 },	{ 0x1294, 0x11 },	{ 0x12A0, 0x11 },
	{ 0x12AC, 0x11 },	{ 0x12B8, 0x11 },	{ 0x12C4, 0x11 },
	{ 0x12D0, 0x11 },	{ 0x12DC, 0x11 },	{ 0x12E8, 0x11 },
	{ 0x1210, 0x4b8 },	{ 0x1224, 0x4b8 },	{ 0x1230, 0x4b8 },
	{ 0x123C, 0x4b8 },	{ 0x1248, 0x4b8 },	{ 0x1254, 0x4b8 },
	{ 0x1260, 0x4b8 },	{ 0x126C, 0x4b8 },	{ 0x1278, 0x4b8 },
	{ 0x1284, 0x4b8 },	{ 0x1290, 0x4b8 },	{ 0x129C, 0x4b8 },
	{ 0x12A8, 0x4b8 },	{ 0x12B4, 0x4b8 },	{ 0x12C0, 0x4b8 },
	{ 0x12CC, 0x4b8 },	{ 0x12D8, 0x4b8 },	{ 0x12E4, 0x4b8 },
	{ 0x12F0, 0x4b8 },	{ 0x218, 0x80000100 },	{ 0x21C, 0x01000100 },
	{ 0x220, 0x00AB008B },	{ 0x248, 0x80000040 },	{ 0x24C, 0x00400040 },
	{ 0x250, 0x002B0023 },	{ 0x278, 0x80000040 },	{ 0x27C, 0x00400040 },
	{ 0x280, 0x002B0023 },	{ 0x2A8, 0x80000080 },	{ 0x2AC, 0x00800080 },
	{ 0x2B0, 0x00550045 },	{ 0x318, 0x80000080 },	{ 0x31C, 0x00800080 },
	{ 0x320, 0x00550045 },	{ 0x348, 0x80000080 },	{ 0x34C, 0x00800080 },
	{ 0x350, 0x00550045 },	{ 0x378, 0x80000080 },	{ 0x37C, 0x00800080 },
	{ 0x380, 0x00550045 },	{ 0x3E8, 0x80000040 },	{ 0x3EC, 0x00400040 },
	{ 0x3F0, 0x002B0023 },	{ 0x418, 0x80000040 },	{ 0x41C, 0x00400040 },
	{ 0x420, 0x002B0023 },	{ 0x488, 0x80000100 },	{ 0x48C, 0x01000100 },
	{ 0x490, 0x00500050 },	{ 0x4B8, 0x800000C0 },	{ 0x4BC, 0x00C000C0 },
	{ 0x4C0, 0x00400040 },	{ 0x4E8, 0x80000080 },	{ 0x4EC, 0x00800080 },
	{ 0x4F0, 0x00550045 },	{ 0x518, 0x80000080 },	{ 0x51C, 0x00800080 },
	{ 0x520, 0x00550045 },	{ 0x588, 0x80000040 },	{ 0x58C, 0x00400040 },
	{ 0x590, 0x002B0023 },	{ 0x5B8, 0x80000040 },	{ 0x5BC, 0x00400040 },
	{ 0x5C0, 0x002B0023 },	{ 0x628, 0x80000040 },	{ 0x62C, 0x00400040 },
	{ 0x630, 0x002B0023 },	{ 0x658, 0x80000040 },	{ 0x65C, 0x00400040 },
	{ 0x660, 0x002B0023 },	{ 0x6C8, 0x80000080 },	{ 0x6CC, 0x00800080 },
	{ 0x6D0, 0x00550045 },	{ 0x738, 0x80000040 },	{ 0x73C, 0x00400040 },
	{ 0x740, 0x002B0023 },	{ 0x7A8, 0x80000040 },	{ 0x7AC, 0x00400040 },
	{ 0x7B0, 0x002B0023 },	{ 0x818, 0x80000080 },	{ 0x81C, 0x00800080 },
	{ 0x820, 0x00550045 },	{ 0x848, 0x80000040 },	{ 0x84C, 0x00400040 },
	{ 0x850, 0x002B0023 },	{ 0x878, 0x80000040 },	{ 0x87C, 0x00400040 },
	{ 0x880, 0x002B0023 },	{ 0x8A8, 0x80000080 },	{ 0x8AC, 0x00800080 },
	{ 0x8B0, 0x00550045 },	{ 0x918, 0x80000040 },	{ 0x91C, 0x00400040 },
	{ 0x920, 0x002B0023 },	{ 0x988, 0x80000040 },	{ 0x98C, 0x00400040 },
	{ 0x990, 0x002B0023 },	{ 0x9F8, 0x80000080 },	{ 0x9FC, 0x00800080 },
	{ 0xA00, 0x00550045 },	{ 0xA28, 0x80000040 },	{ 0xA2C, 0x00400040 },
	{ 0xA30, 0x002B0023 },	{ 0xA98, 0x80000080 },	{ 0xA9C, 0x00800080 },
	{ 0xAA0, 0x00550045 },	{ 0xAC8, 0x80000080 },	{ 0xACC, 0x00800080 },
	{ 0xAD0, 0x00550045 }
};
...
static struct DIP_GET_DUMP_INFO_STRUCT g_dumpInfo = { 0xFFFFFFFF, 0xFFFFFFFF,
...
#define IMGSYS2_REG_CG_CLR IMGSYS_REG_CG_CLR
...
static signed int DIP_Dump_IMGSYS_DIP_Reg(void)
{
	...
	for (DIPNo = 0; DIPNo < mtk_dip_count; DIPNo++) {
		...
		cmdq_util_err("dip: 0x%x2028(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("dip: 0x%x2058(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("dip: 0x%x2168(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("dip: 0x%x2188(0x%x)", DipDumpTL[DIPNo].region,
		...
		/*CQ_THR info*/
		cmdq_util_err(
			"dip: 0x%x2204(0x%x)-0x%x2208(0x%x)-0x%x2210(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*FM register dump*/
		cmdq_util_err(
			"dip: 0x%x8800(0x%x)-0x%x8804(0x%x)-0x%x8808(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("FM debug:0x%x : dip: 0x%x2194(0x%x)",
			      cmdqdebugcmd, DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x1194));

		/*FE register dump*/
		cmdq_util_err(
			"dip: 0x%x8A40(0x%x)-0x%x8A44(0x%x)-0x%x8A48(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*C02_D1 dump*/
		cmdq_util_err(
			"dip: 0x%x5904(0x%x)-0x%x5908(0x%x)-0x%x590c(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*C02_D2 dump*/
		cmdq_util_err(
			"dip: 0x%x5104(0x%x)-0x%x5108(0x%x)-0x%x510c(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*SRZ3 register dump*/
		cmdq_util_err(
			"dip: 0x%x7540(0x%x)-0x%x7544(0x%x)-0x%x7548(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x754C(0x%x)-0x%x7550(0x%x)-0x%x7554(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x7558(0x%x)-0x%x755C(00x%x)-0x%x7560(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*SRZ4 register dump*/
		cmdq_util_err(
			"dip: 0x%x52C0(0x%x)-0x%x52C4(0x%x)-0x%x52C8(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x52CC(0x%x)-0x%x52D0(0x%x)-0x%x52D4(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x52D8(0x%x)-0x%x52DC(0x%x)-0x%x52E0(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*SLK2 register dump*/
		cmdq_util_err(
			"dip: 0x%x5240(0x%x)-0x%x5244(0x%x)-0x%x5248(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x524C(0x%x)-0x%x5250(0x%x)-0x%x5254(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5258(0x%x)-0x%x525C(0x%x)-0x%x5260(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5264(0x%x)-0x%x5268(0x%x)-0x%x526C(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*SLK3 register dump*/
		cmdq_util_err(
			"dip: 0x%x74C0(0x%x)-0x%x74C4(0x%x)-0x%x74C8(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x74CC(0x%x)-0x%x74D0(0x%x)-0x%x74D4(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x74D8(0x%x)-0x%x74DC(0x%x)-0x%x74E0(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x74E4(0x%x)-0x%x74E8(0x%x)-0x%x74EC(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*SLK4 register dump*/
		cmdq_util_err(
			"dip: 0x%x72C0(0x%x)-0x%x72C4(0x%x)-0x%x72C8(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x72CC(0x%x)-0x%x72D0(0x%x)-0x%x72D4(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x72D8(0x%x)-0x%x72DC(0x%x)-0x%x72E0(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x72E4(0x%x)-0x%x72E8(0x%x)-0x%x72EC(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		/*YNR register dump*/
		cmdq_util_err(
			"dip: 0x%x5700(0x%x)-0x%x5704(0x%x)-0x%x5708(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x570C(0x%x)-0x%x5710(0x%x)-0x%x5714(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5718(0x%x)-0x%x571C(0x%x)-0x%x5720(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5724(0x%x)-0x%x5728(0x%x)-0x%x572C(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5730(0x%x)-0x%x5734(0x%x)-0x%x5738(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x573C(0x%x)-0x%x5740(0x%x)-0x%x5744(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5748(0x%x)-0x%x574C(0x%x)-0x%x5750(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5754(0x%x)-0x%x5758(0x%x)-0x%x575C(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5760(0x%x)-0x%x5764(0x%x)-0x%x5768(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x576C(0x%x)-0x%x5770(0x%x)-0x%x5774(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5778(0x%x)-0x%x577C(0x%x)-0x%x5780(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5784(0x%x)-0x%x5788(0x%x)-0x%x578C(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5790(0x%x)-0x%x5794(0x%x)-0x%x5798(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x579C(0x%x)-0x%x57A0(0x%x)-0x%x57A4(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x57A8(0x%x)-0x%x57AC(0x%x)-0x%x57B0(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x57B4(0x%x)-0x%x57B8(0x%x)-0x%x57BC(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x57C0(0x%x)-0x%x57C4(0x%x)-0x%x57C8(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x57CC(0x%x)-0x%x57D0(0x%x)-0x%x57D4(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x57D8(0x%x)-0x%x57DC(0x%x)-0x%x57E0(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x57E4(0x%x)-0x%x57E8(0x%x)-0x%x57EC(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x57F0(0x%x)-0x%x57F4(0x%x)-0x%x57F8(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x57FC(0x%x)-0x%x5800(0x%x)-0x%x5804(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5808(0x%x)-0x%x580C(0x%x)-0x%x5810(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5814(0x%x)-0x%x5818(0x%x)-0x%x581C(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		cmdq_util_err(
			"dip: 0x%x5820(0x%x)-0x%x5824(0x%x)-0x%x5828(0x%x)",
			DipDumpTL[DIPNo].region,
		...
		for (i = 0; i < 104; i++) {
			...
			cmdq_util_err("0x%x : dip: 0x%x2194(0x%x)", dipdmacmd,
				      DipDumpTL[DIPNo].region,
				      DIP_RD32(dipRegBasAddr + 0x1194));
			i++;
			dipdmacmd = dipdmacmd & 0xFFFF00FF;
		...
		for (dd = 0; dd < 0x80; dd++) {
			...
			cmdq_util_err(
				"YW DBG rgb dbg_sel: 0x%08x dbg_out: 0x%08x",
				dbg_sel, dbg_out);
		}
		...
		for (dd = 0; dd < 0x7C; dd++) {
			...
			dbg_out = DIP_RD32(dipRegBasAddr + 0x1194);
			cmdq_util_err(
				"YW DBG yuv dbg_sel: 0x%08x dbg_out: 0x%08x",
				dbg_sel, dbg_out);
		}
		...
		cmdq_util_err("img2o  0x%x1068(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x68));
		cmdq_util_err("img2bo 0x%x106C(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x6C));
		cmdq_util_err("img3o  0x%x1080(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x80));
		cmdq_util_err("img3bo 0x%x1084(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x84));
		cmdq_util_err("img3Co 0x%x1088(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x88));
		cmdq_util_err("feo	 0x%x1070(0x%x)",
			      DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x70));
		cmdq_util_err("dceso  0x%x1054(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x54));
		cmdq_util_err("timgo  0x%x103C(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x3C));
		cmdq_util_err("imgi  0x%x1024(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x24));
		cmdq_util_err("imgbi  0x%x1034(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x34));
		cmdq_util_err("imgci  0x%x1038(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x38));
		cmdq_util_err("vipi  0x%x1074(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x74));
		cmdq_util_err("vip2i  0x%x1078(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x78));
		cmdq_util_err("vip3i  0x%x107C(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x7C));
		cmdq_util_err("dmgi  0x%x1048(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x48));
		cmdq_util_err("depi  0x%x104C(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x4C));
		cmdq_util_err("lcei  0x%x1050(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x50));
		cmdq_util_err("ufdi  0x%x1028(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x28));
		cmdq_util_err("smx1o  0x%x1030(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x30));
		cmdq_util_err("smx2o  0x%x105C(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x5C));
		cmdq_util_err("smx3o  0x%x1064(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x64));
		cmdq_util_err("smx4o  0x%x1044(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x44));
		cmdq_util_err("smx5o  0x%x11D4(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x1D4));
		cmdq_util_err("smx6o  0x%x11DC(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x1DC));
		cmdq_util_err("smx1i  0x%x102C(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x2C));
		cmdq_util_err("smx2i  0x%x1058(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x58));
		cmdq_util_err("smx3i  0x%x1060(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x60));
		cmdq_util_err("smx4i  0x%x1040(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x40));
		cmdq_util_err("smx5i  0x%x11D0(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x1D0));
		cmdq_util_err("smx6i  0x%x11D8(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("imgi: 0x%x1220(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("timgo: 0x%x1384(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("crzo: 0x%x16D4(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("crzbo: 0x%x1744(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("dceso: 0x%x1524(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("feo: 0x%x17B4(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("img3o: 0x%x18B4(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("img3bo: 0x%x1924(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("img3co: 0x%x1994(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("lcei: 0x%x14DC(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("lcei: 0x%x14F0(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("crz: 0x%x8730(0x%x)", DipDumpTL[DIPNo].region,
			      DIP_RD32(dipRegBasAddr + 0x7730));
		cmdq_util_err("crz: 0x%x8734(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("0x%x6A30(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("smt3o: 0x%x1664(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("smt4o: 0x%x1424(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("smt5o: 0x%x1A34(0x%x)", DipDumpTL[DIPNo].region,
		...
		cmdq_util_err("smt6o: 0x%x1AD4(0x%x)", DipDumpTL[DIPNo].region,
...
static signed int DIP_DumpDIPReg(void)
{
	...
	cmdq_util_err("imgsys: 0x%x(0x%x)-0x%x(0x%x)", (DIP_IMGSYS_BASE_HW),
	...
	if (dip_clk.DIP_IMG_MFB_DIP != NULL) {
		...
		cmdq_util_err("MSSDMW_0: 0x%x(0x%x)-0x%x(0x%x)",
			      ...
			      (mss_base_hw + 0x914),
			      DIP_RD32(MSS_BASE + 0x914));
		cmdq_util_err("MSSDMW_0: 0x%x(0x%x)-0x%x(0x%x)",
			      (mss_base_hw + 0x918), DIP_RD32(MSS_BASE + 0x918),
			      (mss_base_hw + 0x91C),
			      DIP_RD32(MSS_BASE + 0x91C));
		...
		cmdq_util_err("MSSDMW_1: 0x%x(0x%x)-0x%x(0x%x)",
			      ...
			      (mss_base_hw + 0x954),
			      DIP_RD32(MSS_BASE + 0x954));
		cmdq_util_err("MSSDMW_1: 0x%x(0x%x)-0x%x(0x%x)",
			      (mss_base_hw + 0x958), DIP_RD32(MSS_BASE + 0x958),
			      (mss_base_hw + 0x95C),
			      DIP_RD32(MSS_BASE + 0x95C));
		...
		cmdq_util_err("MSSDMW_2: 0x%x(0x%x)-0x%x(0x%x)",
			      ...
			      (mss_base_hw + 0x994),
			      DIP_RD32(MSS_BASE + 0x994));
		cmdq_util_err("MSSDMW_2: 0x%x(0x%x)-0x%x(0x%x)",
			      (mss_base_hw + 0x998), DIP_RD32(MSS_BASE + 0x998),
			      (mss_base_hw + 0x99C),
			      DIP_RD32(MSS_BASE + 0x99C));
		...
		cmdq_util_err("MSSDMW_3: 0x%x(0x%x)-0x%x(0x%x)",
			      ...
			      (mss_base_hw + 0x9D4),
			      DIP_RD32(MSS_BASE + 0x9D4));
		cmdq_util_err("MSSDMW_3: 0x%x(0x%x)-0x%x(0x%x)",
			      (mss_base_hw + 0x9D8), DIP_RD32(MSS_BASE + 0x9D8),
			      (mss_base_hw + 0x9DC),
			      DIP_RD32(MSS_BASE + 0x9DC));
		...
		cmdq_util_err("MSSDMR_0: 0x%x(0x%x)-0x%x(0x%x)",
			      ...
			      (mss_base_hw + 0xA14),
			      DIP_RD32(MSS_BASE + 0xA14));
		cmdq_util_err("MSSDMR_0: 0x%x(0x%x)", (mss_base_hw + 0xA18),
		...
		cmdq_util_err("MSSDMR_1: 0x%x(0x%x)-0x%x(0x%x)",
			      ...
			      (mss_base_hw + 0xA54),
			      DIP_RD32(MSS_BASE + 0xA54));
		cmdq_util_err("MSSDMR_1: 0x%x(0x%x)", (mss_base_hw + 0xA58),
		...
		for (i = 0; i < 24; i++) {
			...
			DIP_WR32(MSS_BASE + 0x888, mfbcmd);
			cmdq_util_err(
				"mss4 mod idx:%d cmd:0x%x debug_data(0x%x)", i,
				mfbcmd, DIP_RD32(MSS_BASE + 0x440));
		}
		...
		for (i = 0; i < 4; i++) {
			...
			cmdq_util_err(
				"mss5 mod idx:%d cmd:0x%x debug_data(0x%x)", i,
				mfbcmd, DIP_RD32(MSS_BASE + 0x440));
			mfbcmd = 0x30;
			mfbcmd |= i;
			DIP_WR32(MSS_BASE + 0x434, mfbcmd);
	...
	if (g_bDumpPhyDIPBuf == MFALSE) {
		...
		if (g_bIonBufferAllocated == MFALSE) {
			if (g_pPhyDIPBuffer != NULL) {
				cmdq_util_err(
					"g_pPhyDIPBuffer isn't NULL(0x%pK)",
					g_pPhyDIPBuffer);
			...
			if (g_pPhyMFBBuffer != NULL) {
				cmdq_util_err(
					"g_pPhyMFBBuffer isn't NULL(0x%pK)",
					g_pPhyMFBBuffer);
			...
			if (g_pKWTpipeBuffer != NULL) {
				cmdq_util_err(
					"g_pKWTpipeBuffer isn't NULL(0x%pK)",
					g_pKWTpipeBuffer);
			...
			if (g_pKWCmdqBuffer != NULL) {
				cmdq_util_err(
					"g_KWCmdqBuffer isn't NULL(0x%pK)",
					g_pKWCmdqBuffer);
			...
			if (g_pKWVirDIPBuffer != NULL) {
				cmdq_util_err(
					"g_KWVirDIPBuffer isn't NULL(0x%pK)",
					g_pKWVirDIPBuffer);
		...
		if (g_pPhyDIPBuffer != NULL) {
			...
			if (mtk_dip_count == 2) {
				for (i = 0; i < (DIP_REG_RANGE >> 2);
				     i = i + 4) {
					g_pPhyDIPBuffer[i] =
						DIP_RD32(DIP_B_BASE + (i * 4));
					g_pPhyDIPBuffer[i + 1] = DIP_RD32(
						DIP_B_BASE + ((i + 1) * 4));
					g_pPhyDIPBuffer[i + 2] = DIP_RD32(
						DIP_B_BASE + ((i + 2) * 4));
					g_pPhyDIPBuffer[i + 3] = DIP_RD32(
						DIP_B_BASE + ((i + 3) * 4));
				}
			}
		} else {
			CMDQ_ERR("g_pPhyDIPBuffer:(0x%pK)", g_pPhyDIPBuffer);
		}
		if (g_pPhyMFBBuffer != NULL) {
			if (dip_clk.DIP_IMG_MFB_DIP != NULL) {
				for (i = 0; i < (MFB_REG_RANGE >> 2);
				     i = i + 4) {
					g_pPhyMFBBuffer[i] =
						DIP_RD32(MSF_BASE + (i * 4));
					g_pPhyMFBBuffer[i + 1] = DIP_RD32(
						MSF_BASE + ((i + 1) * 4));
					g_pPhyMFBBuffer[i + 2] = DIP_RD32(
						MSF_BASE + ((i + 2) * 4));
					g_pPhyMFBBuffer[i + 3] = DIP_RD32(
						MSF_BASE + ((i + 3) * 4));
				}
			}
		} else {
		...
		if (g_pPhyMSSBuffer != NULL) {
			if (dip_clk.DIP_IMG_MFB_DIP != NULL) {
				for (i = 0; i < (MSS_REG_RANGE >> 2);
				     i = i + 4) {
					g_pPhyMSSBuffer[i] =
						DIP_RD32(MSS_BASE + (i * 4));
					g_pPhyMSSBuffer[i + 1] = DIP_RD32(
						MSS_BASE + ((i + 1) * 4));
					g_pPhyMSSBuffer[i + 2] = DIP_RD32(
						MSS_BASE + ((i + 2) * 4));
					g_pPhyMSSBuffer[i + 3] = DIP_RD32(
						MSS_BASE + ((i + 3) * 4));
				}
			}
		} else {
		...
		if ((ctrl_start != 0) && (g_tdriaddr != 0) &&
			...
			if (copy_from_user(g_pKWTpipeBuffer,
				...
				cmdq_util_err("cpy tpipe fail. tdriaddr:0x%x",
					      g_tdriaddr);
				cmdq_util_err(
					"MemVa:0x%lx, MemPa:0x%x,offset:0x%x",
					(uintptr_t)g_TpipeBaseAddrInfo.MemVa,
					g_TpipeBaseAddrInfo.MemPa, offset);
			}
		}
		cmdq_util_err("tdraddr:0x%x,MemVa:0x%lx,MemPa:0x%x", g_tdriaddr,
			      (uintptr_t)g_TpipeBaseAddrInfo.MemVa,
			      g_TpipeBaseAddrInfo.MemPa);
		...
		if ((ctrl_start != 0) && (g_cmdqaddr != 0) &&
			...
			cmdq_util_err("cmdqidx:0x%x, cmdqaddr:0x%x", cmdqidx,
				      g_cmdqaddr);
			...
			if (copy_from_user(g_pKWVirDIPBuffer,
				...
				cmdq_util_err(
					"cmdqaddr:0x%x,MVa:0x%lx,MPa:0x%x",
					g_cmdqaddr,
					(uintptr_t)g_CmdqBaseAddrInfo.MemVa,
			...
			cmdq_util_err("MSzDiff:0x%x\n",
				      g_CmdqBaseAddrInfo.MemSizeDiff);
			cmdq_util_err(
				"ofset:0x%x,KWCmdBuf:0x%pK,KWTdrBuf:0x%pK",
			...
			cmdq_util_err("cmdqadd:0x%x,MVa:0x%lx,MPa:0x%x",
				      ...
				      g_CmdqBaseAddrInfo.MemPa);
			cmdq_util_err(
				"MSzDiff:0x%x,KWCmdBuf:0x%pK,KWTdrBuf:0x%pK",
	...
	cmdq_util_err("direct link: cmdqaddr(0x%x), tdriaddr(0x%x)", g_cmdqaddr,
		      g_tdriaddr);
	cmdq_util_err("- X.\n");
	/*  */
...
static inline void Prepare_Enable_ccf_clock(void)
{
	...
	LOG_INF("larb9: %p, larb11: %p ,clk_MFB: %d\n", dip_devs->larb9,
		dip_devs->larb11, dip_clk.DIP_IMG_MFB_DIP);
...
static inline int m4u_control_iommu_port(void)
{
	...
	count_of_ports = M4U_PORT_L9_IMG_UFBC_R0 - M4U_PORT_L9_IMG_IMGI_D1 + 1;
	for (i = 0; i < count_of_ports; i++) {
		...
		if (ret == 0) {
			...
			LOG_INF("config M4U Port %s to %s FAIL(ret=%d)\n",
				iommu_get_port_name(M4U_PORT_L9_IMG_IMGI_D1 +
						    i),
				DIP_MEM_USE_VIRTUL ? "virtual" : "physical",
				ret);
			ret = -1;
	...
	count_of_ports =
		M4U_PORT_L11_IMG_MFB_WDMA1 - M4U_PORT_L11_IMG_MFB_RDMA0 + 1;
	for (i = 0; i < count_of_ports; i++) {
		...
		if (ret == 0) {
			...
			LOG_INF("config M4U Port %s to %s FAIL(ret=%d)\n",
				iommu_get_port_name(M4U_PORT_L11_IMG_MFB_RDMA0 +
						    i),
				DIP_MEM_USE_VIRTUL ? "virtual" : "physical",
				ret);
			ret = -1;
	...
	/* LARB11 */
	count_of_ports =
		M4U_PORT_L11_IMG_UFBC_R0 - M4U_PORT_L11_IMG_IMGI_D1 + 1;
	for (i = 0; i < count_of_ports; i++) {
		...
		if (ret == 0) {
			...
			LOG_INF("config M4U Port %s to %s FAIL(ret=%d)\n",
				iommu_get_port_name(M4U_PORT_L11_IMG_IMGI_D1 +
						    i),
				DIP_MEM_USE_VIRTUL ? "virtual" : "physical",
				ret);
			ret = -1;
	...
	/* LARB13 config all ports */
	count_of_ports =
		M4U_PORT_L9_IMG_UFBC_R0_MDP - M4U_PORT_L9_IMG_IMGI_D1_MDP + 1;
	for (i = 0; i < count_of_ports; i++) {
	...
	for (i = 0; i < count_of_ports; i++) {
		...
		if (ret == 0) {
			...
			LOG_INF("config M4U Port %s to %s FAIL(ret=%d)\n",
				iommu_get_port_name(
					M4U_PORT_L9_IMG_MFB_RDMA0_MDP + i),
				DIP_MEM_USE_VIRTUL ? "virtual" : "physical",
				ret);
			ret = -1;
		}
	...
	for (i = 0; i < count_of_ports; i++) {
		...
		if (ret == 0) {
			...
			LOG_INF("config M4U Port %s to %s FAIL(ret=%d)\n",
				iommu_get_port_name(
					M4U_PORT_L11_IMG_IMGI_D1_DISP + i),
				DIP_MEM_USE_VIRTUL ? "virtual" : "physical",
				ret);
			ret = -1;
		}
...
static signed int DIP_ReadReg(struct DIP_REG_IO_STRUCT *pRegIo)
{
	...
	if (copy_from_user(pData, (void *)pRegIo->pData,
			   (pRegIo->Count) * sizeof(struct DIP_REG_STRUCT)) ==
	    0) {
		for (i = 0; i < pRegIo->Count; i++) {
			if ((DIP_A_BASE + pData->Addr >= DIP_A_BASE) &&
				...
				LOG_INF("DIP_BASE(0x%p), Addr(0x%lx)\n",
					DIP_A_BASE, (unsigned long)pData->Addr);
				pData->Val = 0;
			}
			pData++;
		}
		...
		if (copy_to_user((void *)pRegIo->pData, pData,
				 (pRegIo->Count) *
					 sizeof(struct DIP_REG_STRUCT)) != 0) {
...
static signed int dip_allocbuf(struct dip_imem_memory *pMemInfo)
{
	...
	handle = ion_alloc(dip_p2_ion_client, pMemInfo->length, 0,
	...
	ret = ion_kernel_ioctl(dip_p2_ion_client, ION_CMD_MULTIMEDIA,
...
static signed int DIP_DumpBuffer(struct DIP_DUMP_BUFFER_STRUCT *pDumpBufStruct)
{
	...
	case DIP_DUMP_TPIPEBUF_CMD:
		if (pDumpBufStruct->BytesofBufferSize > max_tdr_no) {
		...
		if (g_bIonBufferAllocated == MFALSE) {
			if (g_pTpipeBuffer == NULL)
				g_pTpipeBuffer = vmalloc(max_tdr_no);
			else
 ...
 **************************************************************/
static signed int
DIP_P2_BufQue_Update_ListCIdx(enum DIP_P2_BUFQUE_PROPERTY property,
 ...
 **************************************************************/
static signed int
DIP_P2_BufQue_GetMatchIdx(struct DIP_P2_BUFQUE_STRUCT param,
	...
	case DIP_P2_BUFQUE_MATCH_TYPE_WAITDQ:
		...
		if (P2_FrameUnit_List_Idx[property].start <=
			...
			if (idx != -1) {
				...
				for (i = 0;
				     i <= P2_FrameUnit_List_Idx[property].end;
				     i++) {
	...
	case DIP_P2_BUFQUE_MATCH_TYPE_WAITFM:
		if (P2_FramePack_List_Idx[property].start <=
			...
			if (idx != -1) {
				...
				for (i = 0;
				     i <= P2_FramePack_List_Idx[property].end;
				     i++) {
					if ((P2_FramePackage_List[property][i]
						     .processID ==
					     param.processID) &&
...
DIP_P2_BufQue_WaitEventState(struct DIP_P2_BUFQUE_STRUCT param,
			     ...
			     signed int *idx)
{
	...
	case DIP_P2_BUFQUE_MATCH_TYPE_WAITFMEQD:
		...
		/* index, */
		/*idx); */
		index = DIP_P2_BufQue_GetMatchIdx(
			param, DIP_P2_BUFQUE_MATCH_TYPE_WAITFM,
...
static signed int DIP_P2_BufQue_CTRL_FUNC(struct DIP_P2_BUFQUE_STRUCT param)
{
				...
				IRQ_LOG_KEEPER(
					...
					P2_FramePackage_List
						...
						[P2_FramePack_List_Idx[property]
							 .start]
							.dupCQIdx,
					P2_FramePackage_List[property][0]
						.dupCQIdx,
					P2_FrameUnit_List_Idx[property].start,
					P2_FrameUnit_List_Idx[property].curr,
					P2_FrameUnit_List_Idx[property].end,
					...
					P2_FrameUnit_List
						...
						[P2_FrameUnit_List_Idx[property]
							 .curr]
							.bufSts,
					P2_FrameUnit_List[property][0].bufSts,
					cqmask);
#endif
			} else {
#ifdef P2_DBG_LOG
	...
	case DIP_P2_BUFQUE_CTRL_WAIT_DEQUE:
		...
		if (idx == -1) {
			...
			LOG_ERR("(pty/pid/cid: %d/0x%x/0x%x)", param.property,
		...
		}
		{
			restTime = wait_event_interruptible_timeout(
				...
				DIP_P2_BufQue_WaitEventState(
					param, DIP_P2_BUFQUE_MATCH_TYPE_WAITDQ,
					&idx),
				DIP_UsToJiffies(15 * 1000000)); /* 15s */
			if (restTime == 0) {
				LOG_ERR("Wait Deque fail, idx(%d),", idx);
	...
	case DIP_P2_BUFQUE_CTRL_DEQUE_SUCCESS:
		...
		/* /////////////////////////////////////////////////////////// */
		idx2 = DIP_P2_BufQue_GetMatchIdx(
			param, DIP_P2_BUFQUE_MATCH_TYPE_FRAMEOP,
			DIP_P2_BUFQUE_LIST_TAG_UNIT);
		if (idx2 == -1) {
			spin_unlock(&(SpinLock_P2FrameList));
		...
		DIP_P2_BufQue_Erase(property, DIP_P2_BUFQUE_LIST_TAG_UNIT,
				    idx2);
		spin_unlock(&(SpinLock_P2FrameList));
	...
	case DIP_P2_BUFQUE_CTRL_WAIT_FRAME:
		...
		restTime = wait_event_interruptible_timeout(
			...
			DIP_P2_BufQue_WaitEventState(
				param, DIP_P2_BUFQUE_MATCH_TYPE_WAITFMEQD,
				&idx),
			DIP_UsToJiffies(15 * 1000000));
		if (restTime == 0) {
			LOG_ERR("could not find match buffer restTime(%d)",
				restTime);
			LOG_ERR("pty/pID/cID (%d/0x%x/0x%x),idx(%d)", property,
		...
		if (P2_FramePackage_List[property][idx].dequedNum ==
			...
			DIP_P2_BufQue_Erase(
				property, DIP_P2_BUFQUE_LIST_TAG_PACKAGE, idx);
			spin_unlock(&(SpinLock_P2FrameList));
			ret = 0;
#ifdef P2_DBG_LOG
		...
		}
		{
			...
			}
			{
				...
				DIP_P2_BufQue_Erase(
					property,
					DIP_P2_BUFQUE_LIST_TAG_PACKAGE, idx);
				spin_unlock(&(SpinLock_P2FrameList));
			}
		}
		break;
...
static signed int DIP_FLUSH_IRQ(struct DIP_WAIT_IRQ_STRUCT *irqinfo)
{
	...
	LOG_INF("type(%d)userKey(%d)St(0x%x)", irqinfo->Type,
...
static long DIP_ioctl(struct file *pFile, unsigned int Cmd, unsigned long Param)
{
	...
	case DIP_GET_DUMP_INFO: {
		if (copy_to_user((void *)Param, &g_dumpInfo,
				 sizeof(struct DIP_GET_DUMP_INFO_STRUCT)) !=
		    0) {
	...
	case DIP_DUMP_BUFFER: {
		if (copy_from_user(&DumpBufStruct, (void *)Param,
				   sizeof(struct DIP_DUMP_BUFFER_STRUCT)) ==
		    0) {
			/* 2nd layer behavoir of copy from user */
	...
	case DIP_GET_GCE_FIRST_ERR: {
		if (copy_from_user(&g_dip1sterr, (void *)Param,
				   sizeof(unsigned int)) == 0) {
		} else {
	...
	case DIP_SET_BUF_PA: {
		if (copy_from_user(&ion_mem_info, (void *)Param,
			...
			dip_ion_list =
				kzalloc(sizeof(struct dip_fd_list_template),
					GFP_KERNEL);
			dip_ion_entry =
				kzalloc(sizeof(struct dip_fd_list_template),
					GFP_KERNEL);
			if (ion_mem_info.check_flag == 1) {
				list_for_each (pos, &dip_fd_head) {
					dip_ion_entry = list_entry(
						pos,
						struct dip_fd_list_template,
						list);
					if (ion_mem_info.buf_fd ==
					    dip_ion_entry->fd) {
						ion_mem_info.buf_pa =
							dip_ion_entry->dma_addr;
					}
				}
			}
			if (ion_mem_info.check_flag == 0) {
				...
				dip_ion_list->buf =
					dma_buf_get(ion_mem_info.buf_fd);
				dip_ion_list->attach = dma_buf_attach(
					dip_ion_list->buf, dip_devs->dev);
				dip_ion_list->sgt = dma_buf_map_attachment(
					dip_ion_list->attach,
					DMA_BIDIRECTIONAL);
				dip_ion_list->dma_addr =
					(unsigned int)sg_dma_address(
						dip_ion_list->sgt->sgl);
				ion_mem_info.buf_pa =
					(unsigned int)sg_dma_address(
						dip_ion_list->sgt->sgl);
				list_add_tail(&dip_ion_list->list,
					      &dip_fd_head);
			}
			if (copy_to_user((void *)Param, &ion_mem_info,
					 sizeof(struct DIP_ION_MEM_INFO)) !=
			    0) {
	...
	case DIP_DET_BUF_FD: {
		if (copy_from_user(&fd, (void *)Param, sizeof(unsigned int)) ==
		    0) {
			if (fd == 0) {
				LOG_ERR("buf fd equal 0\n");
				Ret = -EFAULT;
			...
			mutex_lock(&(DipMutexbuf));
			list_for_each (pos, &dip_fd_head) {
				dip_ion_list = list_entry(
					pos, struct dip_fd_list_template, list);
...
EXIT:
	if (Ret != 0)
		LOG_ERR("Fail, Cmd(%d), Pid(%d),", Cmd, pUserInfo->Pid);
	/*  */
	return Ret;
}
...
static int
compat_get_dip_dump_buffer(struct compat_DIP_DUMP_BUFFER_STRUCT __user *data32,
...
static int
compat_get_dip_mem_info(struct compat_DIP_MEM_INFO_STRUCT __user *data32,
...
static long DIP_ioctl_compat(struct file *filp, unsigned int cmd,
			     unsigned long arg)
{
	long ret = 0;
	...
	case COMPAT_DIP_DEBUG_FLAG: {
		...
		ret = filp->f_op->unlocked_ioctl(
			filp, DIP_DEBUG_FLAG, (unsigned long)compat_ptr(arg));
		return ret;
	}
	case COMPAT_DIP_WAKELOCK_CTRL: {
		ret = filp->f_op->unlocked_ioctl(
			filp, DIP_WAKELOCK_CTRL,
			(unsigned long)compat_ptr(arg));
		return ret;
	}
	case COMPAT_DIP_RESET_BY_HWMODULE: {
		ret = filp->f_op->unlocked_ioctl(
			filp, DIP_RESET_BY_HWMODULE,
			(unsigned long)compat_ptr(arg));
		return ret;
	}
	case COMPAT_DIP_DUMP_BUFFER: {
		...
		ret = filp->f_op->unlocked_ioctl(filp, DIP_DUMP_BUFFER,
						 (unsigned long)data);
		return ret;
	}
	case COMPAT_DIP_SET_MEM_INFO: {
		...
		ret = filp->f_op->unlocked_ioctl(filp, DIP_SET_MEM_INFO,
						 (unsigned long)data);
		return ret;
	}
	case DIP_GET_GCE_FIRST_ERR:
 ...
 *
 **************************************************************/
static signed int DIP_open(struct inode *pInode, struct file *pFile)
{
	signed int Ret = 0;
	unsigned int i;
	int q = 0;
	...
	pFile->private_data =
		kmalloc(sizeof(struct DIP_USER_INFO_STRUCT), GFP_ATOMIC);
	if (pFile->private_data == NULL) {
	...
	g_dip_p2_imem_buf.length = ((4 * DIP_REG_RANGE) + (2 * max_tdr_no) +
				    (2 * MAX_DIP_CMDQ_BUFFER_SIZE) +
				    (MFB_REG_RANGE + MSS_REG_RANGE)(8 * 0x400));
	...
	if (g_bIonBufferAllocated == MTRUE) {
		...
		g_pTuningBuffer =
			(unsigned int *)(((uintptr_t)g_pPhyDIPBuffer) +
					 DIP_REG_RANGE);
		g_pTpipeBuffer = (unsigned int *)(((uintptr_t)g_pTuningBuffer) +
						  DIP_REG_RANGE);
		g_pVirDIPBuffer = (unsigned int *)(((uintptr_t)g_pTpipeBuffer) +
						   max_tdr_no);
		g_pCmdqBuffer = (unsigned int *)(((uintptr_t)g_pVirDIPBuffer) +
						 DIP_REG_RANGE);
		/* Kernel Exception */
		g_pKWTpipeBuffer = (unsigned int *)(((uintptr_t)g_pCmdqBuffer) +
						    MAX_DIP_CMDQ_BUFFER_SIZE);
		g_pKWCmdqBuffer =
...
EXIT:
	...
	LOG_INF("- X. Ret: %d. UserCount: %d, G_u4DipEnClkCnt: %d.\n", Ret,
		IspInfo.UserCount, G_u4DipEnClkCnt);
	return Ret;
}
 ...
 *
 **************************************************************/
static signed int DIP_release(struct inode *pInode, struct file *pFile)
{
	struct DIP_USER_INFO_STRUCT *pUserInfo;
	unsigned int i = 0;
...
EXIT:
	mutex_unlock(&gDipMutex);
	LOG_INF("- X. UserCount: %d. G_u4DipEnClkCnt: %d", IspInfo.UserCount,
		G_u4DipEnClkCnt);
	return 0;
}
...
static signed int DIP_mmap(struct file *pFile, struct vm_area_struct *pVma)
{
	...
	case DIP_A_BASE_HW:
		if (length > DIP_REG_RANGE) {
			...
			LOG_ERR("module(0x%x),length(0x%lx),", pfn, length);
...
static signed int DIP_probe(struct platform_device *pDev)
{
	...
	_dipdev = krealloc(dip_devs, sizeof(struct dip_device) * nr_dip_devs,
			   GFP_KERNEL);
	if (!_dipdev) {
	...
	if (nr_dip_devs == 1) {
		...
		/* parse larb node*/
		node_larb9 =
			of_parse_phandle(pDev->dev.of_node, "mediatek,larb", 0);
		node_larb11 =
			of_parse_phandle(pDev->dev.of_node, "mediatek,larb", 1);
	...
	*(dip_dev->dev->dma_mask) =
	...
	LOG_INF("nr_dip_devs=%d, devnode(%s), map_addr=0x%lx\n", nr_dip_devs,
		pDev->dev.of_node->name, (unsigned long)dip_dev->regs);
	...
	dip_clk.DIP_IMG_LARB9 = devm_clk_get(&pDev->dev, "DIP_CG_IMG_LARB9");
	...
	dip_clk.DIP_IMG_LARB11 = devm_clk_get(&pDev->dev, "DIP_CG_IMG_LARB11");
	dip_clk.DIP_IMG_DIP2 = devm_clk_get(&pDev->dev, "DIP_CG_IMG_DIP2");
...
#if CAM_USE_PM_WAKELOCKS
		dip_wake_lock =
			wakeup_source_register(&pDev->dev, "dip_lock_wakelock");
		isp_mdp_wake_lock =
			wakeup_source_register(&pDev->dev, "isp_mdp_wakelock");
#else
	wake_lock_init(&dip_wake_lock, WAKE_LOCK_SUSPEND, "dip_lock_wakelock");
	wake_lock_init(&isp_mdp_wake_lock, WAKE_LOCK_SUSPEND,
		       "isp_mdp_wakelock");
#endif
...
static signed int DIP_suspend(struct platform_device *pDev, pm_message_t Mesg)
{
	return 0;
}
 ...
 *
 **************************************************************/
static struct platform_driver DipDriver = { .probe = DIP_probe,
					    .remove = DIP_remove,
					    .suspend = DIP_suspend,
					    .resume = DIP_resume,
					    .driver = {
...
static int dip_p2_dump_read(struct seq_file *m, void *v)
{
	...
	LOG_INF("dip p2 g_bDumpPhyB:%d, tdriadd:0x%x, imgiadd:0x%x,dmgiadd:0x%x\n",
		g_bDumpPhyDIPBuf, g_dumpInfo.tdri_baseaddr,
...
ISP_M4U_TranslationFault_callback(int port, unsigned long mva, void *data)
#else
enum m4u_callback_ret_t
ISP_M4U_TranslationFault_callback(int port, unsigned int mva, void *data)
#endif
{
...
#ifdef CONFIG_MTK_IOMMU_V2
enum mtk_iommu_callback_ret_t
MFB_M4U_TranslationFault_callback(int port, unsigned long mva, void *data)
#else
enum m4u_callback_ret_t
MFB_M4U_TranslationFault_callback(int port, unsigned int mva, void *data)
#endif
{
	unsigned int loop = 0;
	...
	pr_info("msftdr:0x%08x, msstdr:0x%08x diptdr:0x%08x",
		DIP_RD32(MSF_BASE + 0x804), DIP_RD32(MSS_BASE + 0x804),
		DIP_RD32(DIP_A_BASE + 0x4));
	pr_info("msfcmdq:0x%08x, msscmdq:0x%08x", DIP_RD32(MSF_BASE + 0x7C0),
		DIP_RD32(MSS_BASE + 0x500));
	pr_info("mss top_cfg:0x%08x, dma_en:0x%08x, eng_en:0x%08x,",
		DIP_RD32(MSS_BASE + 0x400), DIP_RD32(MSS_BASE + 0x404),
		DIP_RD32(MSS_BASE + 0x408));
	pr_info("msf top_ctl:0x%08x, dma_en:0x%08x, eng_en:0x%08x,",
		DIP_RD32(MSF_BASE + 0x480), DIP_RD32(MSF_BASE + 0x49C),
		DIP_RD32(MSF_BASE + 0x4A0));
	pr_info("baseiy:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xA00), DIP_RD32(MSF_BASE + 0xA04),
		DIP_RD32(MSF_BASE + 0xA08), DIP_RD32(MSF_BASE + 0xA0C));
	pr_info("baseic:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xA40), DIP_RD32(MSF_BASE + 0xA44),
		DIP_RD32(MSF_BASE + 0xA48), DIP_RD32(MSF_BASE + 0xA4C));
	pr_info("confi:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xC80), DIP_RD32(MSF_BASE + 0xC84),
		DIP_RD32(MSF_BASE + 0xC88), DIP_RD32(MSF_BASE + 0xC8C));
	...
	pr_info("wei:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xC00), DIP_RD32(MSF_BASE + 0xC04),
		DIP_RD32(MSF_BASE + 0xC08), DIP_RD32(MSF_BASE + 0xC0C));
	pr_info("refic:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xAC0), DIP_RD32(MSF_BASE + 0xAC4),
		DIP_RD32(MSF_BASE + 0xAC8), DIP_RD32(MSF_BASE + 0xACC));
	pr_info("dswi:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xC40), DIP_RD32(MSF_BASE + 0xC44),
		DIP_RD32(MSF_BASE + 0xC48), DIP_RD32(MSF_BASE + 0xC4C));
	pr_info("idiy:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xB80), DIP_RD32(MSF_BASE + 0xB84),
		DIP_RD32(MSF_BASE + 0xB88), DIP_RD32(MSF_BASE + 0xB8C));
	...
	pr_info("refiy:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xA80), DIP_RD32(MSF_BASE + 0xA84),
		DIP_RD32(MSF_BASE + 0xA88), DIP_RD32(MSF_BASE + 0xA8C));
	pr_info("dsiy:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xB00), DIP_RD32(MSF_BASE + 0xB04),
		DIP_RD32(MSF_BASE + 0xB08), DIP_RD32(MSF_BASE + 0xB0C));
	pr_info("dsic:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xB40), DIP_RD32(MSF_BASE + 0xB44),
		DIP_RD32(MSF_BASE + 0xB48), DIP_RD32(MSF_BASE + 0xB4C));
	pr_info("idic:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0xBC0), DIP_RD32(MSF_BASE + 0xBC4),
		DIP_RD32(MSF_BASE + 0xBC8), DIP_RD32(MSF_BASE + 0xBCC));
	...
	pr_info("msf top_ctl:0x%08x, dma_en:0x%08x, eng_en:0x%08x,",
		DIP_RD32(MSF_BASE + 0x480), DIP_RD32(MSF_BASE + 0x49C),
		DIP_RD32(MSF_BASE + 0x4A0));
	pr_info("omcmv:0x%08x, stride:0x%08x,", DIP_RD32(MSS_BASE + 0x120),
	...
	pr_info("omciy:0x%08x, ofset:0x%08x, stride:0x%08x,",
		DIP_RD32(MSS_BASE + 0x18C), DIP_RD32(MSS_BASE + 0x190),
		DIP_RD32(MSS_BASE + 0x194));
	pr_info("omcic:0x%08x, ofset:0x%08x, stride:0x%08x,",
		DIP_RD32(MSS_BASE + 0x198), DIP_RD32(MSS_BASE + 0x19C),
	...
	pr_info("fsoy:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0x900), DIP_RD32(MSF_BASE + 0x904),
		DIP_RD32(MSF_BASE + 0x908), DIP_RD32(MSF_BASE + 0x90C));
	pr_info("fsoc:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0x940), DIP_RD32(MSF_BASE + 0x944),
		DIP_RD32(MSF_BASE + 0x948), DIP_RD32(MSF_BASE + 0x94C));
	pr_info("weo:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0x980), DIP_RD32(MSF_BASE + 0x984),
		DIP_RD32(MSF_BASE + 0x988), DIP_RD32(MSF_BASE + 0x98C));
	pr_info("dswo:0x%08x, ofset:0x%08x, size:0x%08x, stride:0x%08x,",
		DIP_RD32(MSF_BASE + 0x9C0), DIP_RD32(MSF_BASE + 0x9C4),
		DIP_RD32(MSF_BASE + 0x9C8), DIP_RD32(MSF_BASE + 0x9CC));
...
static signed int __init DIP_Init(void)
{
	...
	proc_entry =
		proc_create("dip_dump", 0444, dip_p2_dir, &dip_dump_proc_fops);
	proc_entry = proc_create("isp_p2_dump", 0444, dip_p2_dir,
				 &dip_p2_dump_proc_fops);
	proc_entry = proc_create("isp_p2_kedump", 0444, dip_p2_dir,
				 &dip_p2_ke_dump_proc_fops);
	...
	cmdqCoreRegisterCB(mdp_get_group_isp(), NULL, DIP_MDPDumpCallback,
			   DIP_MDPResetCallback, NULL);
	/* Register GCE callback for dumping DIP register */
	LOG_DBG("register dip callback for GCE");
	cmdqCoreRegisterDebugRegDumpCB(DIP_BeginGCECallback,
				       DIP_EndGCECallback);
#endif
...
int32_t DIP_BeginGCECallback(uint32_t taskID, uint32_t *regCount,
			     uint32_t **regAddress)
{
#if DUMP_GCE_TPIPE
...
int32_t DIP_EndGCECallback(uint32_t taskID, uint32_t regCount,
			   uint32_t *regValues)
{
#if DUMP_GCE_TPIPE
...
#define TPIPE_DUMP_SIZE 200
	...
	if ((tpipePA)) {
		...
		if (dip_allocbuf(&dip_p2GCEdump_imem_buf) >= 0) {
			...
			LOG_DBG("ctlStart(0x%x),tpipePA(0x%x)", ctlStart,
				tpipePA);

			if (pMapVa) {
				for (i = 0; i < TPIPE_DUMP_SIZE; i += 10) {
					LOG_DBG("[idx(%d)]%08X-%08X-%08X-%08X-%08X",
						i, pMapVa[i], pMapVa[i + 1],
