...
#include <linux/string.h> // Para strcmp
#ifndef IS_SKHYNIX_DEVICE
#define IS_SKHYNIX_DEVICE(mfrid) (0 == strcmp(mfrid, "SKHYNIX"))
#endif

void ufs_mtk_dbg_dump(unsigned int latest_cnt);
...
static int ufs_mtk_init(struct ufs_hba *hba)
{
	...
	{
		/* Declaramos la variable externa que el vendor espera */
		char storage_mfrid[10] = "UNKNOWN";
