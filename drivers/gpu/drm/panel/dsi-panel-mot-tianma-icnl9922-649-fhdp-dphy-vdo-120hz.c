...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	tianma_dcs_write_seq_static(ctx, 0xCC, 0x01);
	...
	tianma_dcs_write_seq_static(ctx, 0xBD, 0xA1, 0xA2);
...
static int pane_cabc_set_cmdq(struct tianma *ctx, void *dsi, dcs_grp_write_gce cb, void *handle, uint32_t hbm_state)
{
	...
	struct mtk_panel_para_table cabc_mv_table[7] = {
		{2, {0x55, 0x03}},
		{3, {0xF0,0x5A,0x59}},
		{3, {0xF1,0xA5,0xA6}},
		{33, {0xE7,0x30,0x00,0x40,0xD5,0x01,0x1F,0x20,0x42,0x1F,0xA0,0x24,0xCC,0x01,0x00,0x00,0x30,0x18,0x15,0x00,0xA8,0xFF,0xFF,0xF0,0xF0,0xF0,0xF0,0xF0,0xFF,0xF5,0xF8,0xFB,0xFF}},
		{33, {0xE8,0x04,0x10,0x24,0x38,0x4C,0x60,0x74,0x88,0x9C,0xB0,0xC4,0xD8,0x98,0x84,0xBB,0xBB,0xCD,0xDD,0xEE,0xFF,0xE7,0xEF,0xF7,0xFF,0x87,0x10,0x99,0xFB,0x5D,0xBF,0x21,0x84}},
		{3, {0xF0,0xA5,0xA5}},
		{3, {0xF1,0x5A,0x5A}}
	};
