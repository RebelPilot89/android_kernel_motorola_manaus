...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xD0, 0x84,0x35,0x50,0x14,0x20,0x00,0x39,0x07,0x22,0x19,0x00,0x00,0x07,0x22,0x1a,0x00,0x00,0x0b,0x05,0x05,0x22,0x22);
	...
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xAA, 0x12);
	lcm_dcs_write_seq_static(ctx, 0x65, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xd9, 0x0f);
...
static struct mtk_panel_params ext_params_60hz = {
	...
	.panel_ver = 1,
	.panel_id = 0x010b1591,
	.panel_name = "panel-tianma-vtdr6115-vdo-144hz-u8",
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-tianma-vtdr6115-vdo-144hz-u8",
		.owner = THIS_MODULE,
