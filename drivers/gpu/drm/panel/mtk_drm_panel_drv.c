...
/* STUBS CORREGIDOS PARA COINCIDIR CON CABECERAS MTK */
...
/* Eliminamos los stubs de mtk_panel_ext porque ahora compilaremos el archivo real */

void tcpm_typec_disable_function(void *tcpc_dev, int func) {}
/* FIN DE STUBS */
