...
static void boe_panel_init(struct boe *ctx)
{
	...
	boe_dcs_write_seq_static(ctx, 0xB1, 0x2C, 0xB3, 0xB3, 0x2F, 0xEF, 0x43,
				 0xE1, 0x50, 0x36, 0x36, 0x36, 0x36, 0x1A, 0x8B,
				 0x11, 0x65, 0x00, 0x88, 0xFA, 0xFF, 0xFF, 0x8F,
				 0xFF, 0x08, 0x9A, 0x33);
	boe_dcs_write_seq_static(ctx, 0xB2, 0x00, 0x47, 0xB0, 0xD0, 0x00, 0x12,
				 0xC4, 0x3C, 0x36, 0x32, 0x30, 0x10, 0x00, 0x88,
				 0xF5);
	boe_dcs_write_seq_static(ctx, 0xB4, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C,
				 0x49, 0x3F, 0x7C, 0x70, 0x01, 0x49);
	...
	boe_dcs_write_seq_static(ctx, 0xC0, 0x3A, 0x3A, 0x22, 0x11, 0x22, 0xA0,
				 0x61, 0x08, 0xF5, 0x03);
	...
	boe_dcs_write_seq_static(ctx, 0xE9, 0x3F);
	boe_dcs_write_seq_static(ctx, 0xD1, 0x37, 0x06, 0x00, 0x02, 0x04, 0x0C,
				 0xFF);
	boe_dcs_write_seq_static(ctx, 0xD3, 0x06, 0x00, 0x00, 0x00, 0x40, 0x04,
				 0x08, 0x04, 0x08, 0x37, 0x47, 0x64, 0x4B, 0x11,
				 0x11, 0x03, 0x03, 0x32, 0x10, 0x0C, 0x00, 0x0C,
				 0x32, 0x10, 0x08, 0x00, 0x08, 0x32, 0x17, 0xE7,
				 0x07, 0xE7, 0x00, 0x00);
	boe_dcs_write_seq_static(ctx, 0xD5, 0x24, 0x24, 0x24, 0x24, 0x07, 0x06,
				 0x07, 0x06, 0x05, 0x04, 0x05, 0x04, 0x03, 0x02,
				 0x03, 0x02, 0x01, 0x00, 0x01, 0x00, 0x21, 0x20,
				 0x21, 0x20, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
				 0x18, 0x18, 0x1F, 0x1F, 0x1F, 0x1F, 0x1E, 0x1E,
				 0x1E, 0x1E, 0x18, 0x18, 0x18, 0x18);
	boe_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xAA, 0xAA, 0xAA, 0xFA, 0xA0,
				 0xAA, 0xAA, 0xAA, 0xAA, 0xFA, 0xA0);
	boe_dcs_write_seq_static(ctx, 0xE0, 0x00, 0x04, 0x0D, 0x15, 0x1D, 0x32,
				 0x4F, 0x58, 0x62, 0x5F, 0x7D, 0x85, 0x8A, 0x9A,
				 0x9A, 0x9E, 0xA5, 0xB6, 0xB2, 0x56, 0x5E, 0x67,
				 0x73, 0x00, 0x04, 0x0D, 0x15, 0x1D, 0x32, 0x4F,
				 0x58, 0x62, 0x5F, 0x7D, 0x85, 0x8A, 0x9A, 0x9A,
				 0x9E, 0xA5, 0xB6, 0xB2, 0x56, 0x5E, 0x67,
				 0x73);
	boe_dcs_write_seq_static(ctx, 0xE7, 0x28, 0x08, 0x08, 0x3B, 0x3F, 0x49,
				 0x03, 0xC4, 0x48, 0x14, 0x14, 0x00, 0x00, 0x00,
				 0x00, 0x12, 0x05, 0x02, 0x02, 0x08, 0x33, 0x03,
				 0x84);
	boe_dcs_write_seq_static(ctx, 0xE1, 0x12, 0x00, 0x00, 0x89, 0x30, 0x80,
				 0x07, 0xD0, 0x02, 0x58, 0x00, 0x05, 0x02, 0x58,
				 0x02, 0x58, 0x02, 0x00, 0x02, 0x2C, 0x00, 0x20,
				 0x00, 0x75, 0x00, 0x08, 0x00, 0x0C, 0x18, 0x00,
				 0x12, 0x4E, 0x18, 0x00, 0x10, 0xF0, 0x03, 0x0C,
	...
	boe_dcs_write_seq_static(ctx, 0xE1, 0x40, 0x09, 0xBE, 0x19, 0xFC, 0x19,
				 0xFA, 0x19, 0xF8, 0x1A, 0x38, 0x1A, 0x78, 0x1A,
				 0xB6, 0x2A, 0xF6, 0x2B, 0x34, 0x2B, 0x74, 0x3B,
				 0x74, 0x6B, 0x74);
	...
	boe_dcs_write_seq_static(ctx, 0xE9, 0x3F);
	boe_dcs_write_seq_static(ctx, 0xD8, 0xFF, 0xFF, 0xFA, 0xAF, 0xFF, 0xA0,
				 0xFF, 0xFF, 0xFA, 0xAF, 0xFF, 0xA0, 0xFF, 0xFF,
				 0xFA, 0xAF, 0xFF, 0xA0, 0xFF, 0xFF, 0xFA, 0xAF,
				 0xFF, 0xA0, 0xFF, 0xFF, 0xFA, 0xAF, 0xFF, 0xA0,
				 0xFF, 0xFF, 0xFA, 0xAF, 0xFF, 0xA0);
	boe_dcs_write_seq_static(ctx, 0xE2, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C,
				 0x4D, 0x43, 0x7C, 0x70, 0x04, 0x68, 0x01, 0x4D,
				 0x01, 0x00, 0x20, 0x01, 0x03, 0x00, 0x00, 0x0F,
				 0x0F, 0x0F, 0x0F, 0x00, 0x00, 0x00, 0x1F, 0x0E,
				 0x0E, 0x32, 0x3C, 0x4C, 0x04, 0xFE, 0x4C, 0x14,
				 0x14, 0x00, 0x00, 0xBF, 0x01, 0x33, 0x47, 0x33,
				 0x48, 0x00, 0x20, 0x4D, 0x00, 0x36, 0x00, 0x07,
				 0x0B, 0x00);
	boe_dcs_write_seq_static(ctx, 0xE7, 0x02, 0x00, 0xBC, 0x01, 0x14, 0x07,
				 0xAA, 0x08, 0xA0, 0x04, 0x00);
	boe_dcs_write_seq_static(ctx, 0xBD, 0x02);
	boe_dcs_write_seq_static(ctx, 0xD8, 0xFF, 0xFF, 0xFA, 0xAF, 0xFF, 0xA0,
				 0xFF, 0xFF, 0xFA, 0xAF, 0xFF, 0xA0);
	boe_dcs_write_seq_static(ctx, 0xE2, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C, 0x3C,
				 0x4B, 0x41, 0x7C, 0x70, 0x04, 0x68, 0x01, 0x4B,
				 0x01, 0x00, 0x20, 0x01, 0x03, 0x00, 0x00, 0x0F,
				 0x0F, 0x0F, 0x0F, 0x00, 0x00, 0x00, 0x25, 0x1C,
				 0x1C, 0x38, 0x40, 0x4B, 0x02, 0xE8, 0x8B, 0x14,
				 0x14, 0x00, 0x00, 0xC9, 0x01, 0x33, 0x47, 0x33,
				 0x48, 0x00, 0x20, 0x4B, 0x00, 0x36, 0x00, 0x07,
				 0x0B, 0x00);
	boe_dcs_write_seq_static(ctx, 0xE7, 0xFE, 0x03, 0xFE, 0x03, 0xFE, 0x03,
				 0x02, 0x02, 0x02, 0x25, 0x00, 0x25, 0x81, 0x02,
				 0x40, 0x00, 0x20, 0x49, 0x04, 0x03, 0x02, 0x01,
				 0x00, 0x00, 0x00, 0x00, 0x01, 0x00);
	boe_dcs_write_seq_static(ctx, 0xBD, 0x03);
	boe_dcs_write_seq_static(ctx, 0xD8, 0xAA, 0xAA, 0xAA, 0xAA, 0xFA, 0xA0,
				 0xAA, 0xAA, 0xAA, 0xAA, 0xFA, 0xA0, 0xFF, 0xFF,
				 0xFA, 0xAF, 0xFF, 0xA0, 0xFF, 0xFF, 0xFA, 0xAF,
				 0xFF, 0xA0, 0x55, 0x55, 0x55, 0x55, 0x55, 0x50,
	...
	boe_dcs_write_seq_static(ctx, 0xBD, 0x03);
	boe_dcs_write_seq_static(ctx, 0xC1, 0x00, 0x04, 0x08, 0x0B, 0x10, 0x14,
				 0x18, 0x1C, 0x20, 0x24, 0x28, 0x2C, 0x30, 0x34,
				 0x39, 0x3E, 0x43, 0x47, 0x4B, 0x4F, 0x56, 0x5D,
				 0x65, 0x6D, 0x74, 0x7C, 0x84, 0x8B, 0x94, 0x9C,
				 0xA4, 0xAB, 0xB4, 0xBB, 0xC3, 0xCB, 0xD2, 0xDA,
				 0xE3, 0xEB, 0xF3, 0xF7, 0xF9, 0xFB, 0xFD, 0xFF,
				 0x07, 0x05, 0x92, 0x64, 0x69, 0xB0, 0x03, 0x63,
				 0x14, 0xF4, 0x6F, 0xC0);
	boe_dcs_write_seq_static(ctx, 0xBD, 0x02);
	boe_dcs_write_seq_static(ctx, 0xC1, 0x00, 0x03, 0x08, 0x0B, 0x10, 0x14,
				 0x18, 0x1C, 0x20, 0x24, 0x28, 0x2C, 0x30, 0x34,
				 0x39, 0x3E, 0x43, 0x47, 0x4B, 0x4F, 0x56, 0x5D,
				 0x65, 0x6D, 0x74, 0x7C, 0x84, 0x8C, 0x94, 0x9D,
				 0xA4, 0xAC, 0xB4, 0xBB, 0xC3, 0xCC, 0xD4, 0xDC,
				 0xE4, 0xEC, 0xF4, 0xF8, 0xFA, 0xFC, 0xFE, 0xFF,
				 0x17, 0x05, 0x92, 0x64, 0x69, 0xB0, 0xFA, 0xC5,
				 0x69, 0x05, 0x04, 0x00);
	boe_dcs_write_seq_static(ctx, 0xBD, 0x01);
	boe_dcs_write_seq_static(ctx, 0xC1, 0x00, 0x04, 0x08, 0x0B, 0x10, 0x14,
				 0x18, 0x1C, 0x20, 0x24, 0x28, 0x2C, 0x30, 0x34,
...
#ifdef HIMAX_WAKE_UP
	if (wake_flag_drm == 0) {
		boe_dcs_write_seq_static(ctx, 0xB9, 0x83, 0x10, 0x21, 0x55,
					 0x00);
...
get_mode_by_id_hfp(struct drm_connector *connector, unsigned int mode)
{
...
static int boe_probe(struct mipi_dsi_device *dsi)
{
	...
	if (ctx->gate_ic == 0) {
		ctx->bias_pos =
			devm_gpiod_get_index(dev, "bias", 0, GPIOD_OUT_HIGH);
		...
		ctx->bias_neg =
			devm_gpiod_get_index(dev, "bias", 1, GPIOD_OUT_HIGH);
	...
	ctx->prepared = true;
	ctx->enabled = true;
	drm_panel_init(&ctx->panel, dev, &boe_drm_funcs,
