...
static struct reg_default bq25980_reg_init_val[] = {
	...
	{ BQ25980_BATOCP,
	  0xEE }, //0xEE:disable for dual //0x64:11000mA for standalone
...
static struct reg_default sc8541_reg_init_val[] = {
	...
	{ BQ25980_BATOCP,
	  0xEE }, //0xEE:disable for dual //0x46:7000mA for standalone
	{ BQ25980_BATOCP_ALM, 0x7F }, //0x7F:12700mA
	...
	{ BQ25980_CHRGR_CTRL_4,
	  0xf1 }, //5m oum battery sense resister & ss_timeout is 10s
	...
	{ BQ25980_ADC_CONTROL2,
	  0x06 }, //0x26: enable vac1 vac2 adc and vout adc
...
static struct reg_default bq25980_reg_defs[] = {
	{ BQ25980_BATOVP, 0x5A },	{ BQ25980_BATOVP_ALM, 0x46 },
	{ BQ25980_BATOCP, 0x51 },	{ BQ25980_BATOCP_ALM, 0x50 },
	{ BQ25980_CHRGR_CFG_1, 0x28 },	{ BQ25980_CHRGR_CTRL_1, 0x0 },
	{ BQ25980_BUSOVP, 0x26 },	{ BQ25980_BUSOVP_ALM, 0x22 },
	{ BQ25980_BUSOCP, 0xD },	{ BQ25980_REG_09, 0xC },
	{ BQ25980_TEMP_CONTROL, 0x30 }, { BQ25980_TDIE_ALM, 0xC8 },
	{ BQ25980_TSBUS_FLT, 0x15 },	{ BQ25980_TSBAT_FLG, 0x15 },
	{ BQ25980_VAC_CONTROL, 0x0 },	{ BQ25980_CHRGR_CTRL_2, 0x0 },
	{ BQ25980_CHRGR_CTRL_3, 0x20 }, { BQ25980_CHRGR_CTRL_4, 0x1D },
	{ BQ25980_CHRGR_CTRL_5, 0x18 }, { BQ25980_STAT1, 0x0 },
	{ BQ25980_STAT2, 0x0 },		{ BQ25980_STAT3, 0x0 },
	{ BQ25980_STAT4, 0x0 },		{ BQ25980_STAT5, 0x0 },
	{ BQ25980_FLAG1, 0x0 },		{ BQ25980_FLAG2, 0x0 },
	{ BQ25980_FLAG3, 0x0 },		{ BQ25980_FLAG4, 0x0 },
	{ BQ25980_FLAG5, 0x0 },		{ BQ25980_MASK1, 0x0 },
	{ BQ25980_MASK2, 0x0 },		{ BQ25980_MASK3, 0x0 },
	{ BQ25980_MASK4, 0x0 },		{ BQ25980_MASK5, 0x0 },
	{ BQ25980_DEVICE_INFO, 0x8 },	{ BQ25980_ADC_CONTROL1, 0x0 },
	{ BQ25980_ADC_CONTROL2, 0x0 },	{ BQ25980_IBUS_ADC_LSB, 0x0 },
	{ BQ25980_IBUS_ADC_MSB, 0x0 },	{ BQ25980_VBUS_ADC_LSB, 0x0 },
	{ BQ25980_VBUS_ADC_MSB, 0x0 },	{ BQ25980_VAC1_ADC_LSB, 0x0 },
	{ BQ25980_VAC2_ADC_LSB, 0x0 },	{ BQ25980_VOUT_ADC_LSB, 0x0 },
	{ BQ25980_VBAT_ADC_LSB, 0x0 },	{ BQ25980_IBAT_ADC_MSB, 0x0 },
	{ BQ25980_IBAT_ADC_LSB, 0x0 },	{ BQ25980_TSBUS_ADC_LSB, 0x0 },
	{ BQ25980_TSBAT_ADC_LSB, 0x0 }, { BQ25980_TDIE_ADC_LSB, 0x0 },
	{ BQ25980_DEGLITCH_TIME, 0x0 }, { BQ25980_CHRGR_CTRL_6, 0x0 },
};
...
static struct reg_default sc8541_reg_defs[] = {
	{ BQ25980_BATOVP, 0x4a },	{ BQ25980_BATOVP_ALM, 0x42 },
	{ BQ25980_BATOCP, 0x51 },	{ BQ25980_BATOCP_ALM, 0x50 },
	{ BQ25980_CHRGR_CFG_1, 0x0 },	{ BQ25980_CHRGR_CTRL_1, 0x0 },
	{ BQ25980_BUSOVP, 0x26 },	{ BQ25980_BUSOVP_ALM, 0x22 },
	{ BQ25980_BUSOCP, 0xD },	{ BQ25980_REG_09, 0x0 },
	{ BQ25980_TEMP_CONTROL, 0x00 }, { BQ25980_TDIE_ALM, 0xC8 },
	{ BQ25980_TSBUS_FLT, 0x15 },	{ BQ25980_TSBAT_FLG, 0x15 },
	{ BQ25980_VAC_CONTROL, 0x0 },	{ BQ25980_CHRGR_CTRL_2, 0x0 },
	{ BQ25980_CHRGR_CTRL_3, 0x20 }, { BQ25980_CHRGR_CTRL_4, 0x1D },
	{ BQ25980_CHRGR_CTRL_5, 0x18 }, { BQ25980_STAT1, 0x0 },
	...
	{ BQ25980_MASK2, 0x0 },		{ BQ25980_MASK3, 0x0 },
	{ BQ25980_MASK4, 0x0 },		{ BQ25980_MASK5, 0x0 },
	{ BQ25980_DEVICE_INFO, 0x41 },	{ BQ25980_ADC_CONTROL1, 0x0 },
	{ BQ25980_ADC_CONTROL2, 0x0 },	{ BQ25980_IBUS_ADC_LSB, 0x0 },
	{ BQ25980_IBUS_ADC_MSB, 0x0 },	{ BQ25980_VBUS_ADC_LSB, 0x0 },
	{ BQ25980_VBUS_ADC_MSB, 0x0 },	{ BQ25980_VAC1_ADC_LSB, 0x0 },
	{ BQ25980_VAC2_ADC_LSB, 0x0 },	{ BQ25980_VOUT_ADC_LSB, 0x0 },
...
static int bq25980_get_const_charge_curr(struct bq25980_device *bq)
{
	...
	return (batocp_reg_code & BQ25980_BATOCP_MASK) * BQ25980_BATOCP_STEP_uA;
}
...
static int bq25980_get_adc_vbus(struct bq25980_device *bq)
{
	...
	return bq->chip_info->adc_vbus_volt_offset +
	       vbus_adc * bq->chip_info->adc_vbus_volt_step / 10;
}
...
static int bq25980_get_adc_vout(struct bq25980_device *bq)
{
	...
	return bq->chip_info->adc_vout_volt_offset +
	       vout_adc * bq->chip_info->adc_vout_volt_step / 10;
}
...
{
	if (state->vbus_ovp)
		charger_dev_notify(bq->chg_dev, CHARGER_DEV_NOTIFY_VBUS_OVP);
	else if (state->bat_ovp)
		charger_dev_notify(bq->chg_dev, CHARGER_DEV_NOTIFY_BAT_OVP);
	else if (state->vout_ovp)
		charger_dev_notify(bq->chg_dev, CHARGER_DEV_NOTIFY_VOUTOVP);
	else if (state->bus_ocp)
		charger_dev_notify(bq->chg_dev, CHARGER_DEV_NOTIFY_IBUSOCP);
	else if (state->bat_ocp)
		charger_dev_notify(bq->chg_dev, CHARGER_DEV_NOTIFY_IBATOCP);
			     ...
			     struct bq25980_state *state)
{
	...
	dev_info(
		bq->dev,
		"dc=%d,ovp=%d,%d,%d,%d,ocp=%d,%d,ucp=%d,t=%d,wdt=%d,online=%d,ce=%d,hiz=%d,bypass=%d\n",
		state->dischg, state->vac_ovp, state->bat_ovp, state->vout_ovp,
		state->vbus_ovp, state->bus_ocp, state->bat_ocp, state->bus_ucp,
		state->tflt, state->wdt, state->online, state->ce, state->hiz,
		state->bypass);
...
static int bq25980_parse_dt(struct bq25980_device *bq)
{
	...
	ret = device_property_read_u32(bq->dev, "ti,sc-ovp-limit-microvolt",
	...
	ret = device_property_read_u32(bq->dev, "ti,sc-ocp-limit-microamp",
	...
	ret = device_property_read_u32(bq->dev, "ti,bypass-ovp-limit-microvolt",
	...
	ret = device_property_read_u32(bq->dev, "ti,bypass-ocp-limit-microamp",
	...
	bq->state.bypass =
		device_property_read_bool(bq->dev, "ti,bypass-enable");
	return 0;
}
...
static int bq25980_parse_dt_id(struct bq25980_device *bq, int driver_data)
{
	...
	case BQ25980_MASTER:
		...
		break;
	default:
		dev_err(bq->dev, "dts compatible id %d is unknown",
			driver_data);
		return -EINVAL;
		break;
	}
...
static ssize_t show_reg_addr(struct device *dev, struct device_attribute *attr,
			     char *buf)
{
...
static ssize_t store_reg_addr(struct device *dev, struct device_attribute *attr,
...
static ssize_t show_reg_data(struct device *dev, struct device_attribute *attr,
			     char *buf)
{
	struct bq25980_device *bq = dev_get_drvdata(dev);
	if (!bq) {
...
static ssize_t store_reg_data(struct device *dev, struct device_attribute *attr,
			      const char *buf, size_t count)
{
	int tmp;
	struct bq25980_device *bq = dev_get_drvdata(dev);
...
static ssize_t show_force_chg_auto_enable(struct device *dev,
...
static DEVICE_ATTR(force_chg_auto_enable, 0664, show_force_chg_auto_enable,
		   store_force_chg_auto_enable);
...
static int bq25980_get_adc(struct charger_device *chg_dev,
...
static int __maybe_unused bq25980_is_vbushigherr(struct charger_device *chg_dev,
						 bool *err)
{
	unsigned int val;
	int tmp;
			     ...
			     enum mmi_dvchg_mux_channel wls_mos)
{
	...
	if (typec_mos != MMI_DVCHG_MUX_OTG_OPEN &&
	    wls_mos != MMI_DVCHG_MUX_OTG_OPEN) {
		ret = regmap_update_bits(bq->regmap, BQ25980_CHRGR_CTRL_2,
					 BQ25980_EN_OTG, 0);
		if (ret) {
			dev_err(bq->dev, "%s:mmi_mux close en otg fail ret=%d",
				__func__, ret);
			return ret;
		}
	}
	if (typec_mos != MMI_DVCHG_MUX_OTG_OPEN &&
	    wls_mos != MMI_DVCHG_MUX_OTG_OPEN &&
	    typec_mos != MMI_DVCHG_MUX_DISABLE &&
	    wls_mos != MMI_DVCHG_MUX_DISABLE &&
	    wls_mos != MMI_DVCHG_MUX_MANUAL_OPEN) {
		ret = regmap_update_bits(bq->regmap, SC8541_CTRL6_REG,
					 SC8541_ACDRV_MANUAL_EN, 0);
		if (ret) {
			dev_err(bq->dev, "%s:mmi_mux dis mos both fail ret=%d",
				__func__, ret);
			return ret;
		}
	}
	...
	if (typec_mos == MMI_DVCHG_MUX_CLOSE) {
		...
		if (ret) {
			dev_err(bq->dev,
				"%s mmi_mux close typec mos fail ret=%d",
				__func__, ret);
			return ret;
		}
		udelay(100);
	...
	if (wls_mos == MMI_DVCHG_MUX_CLOSE) {
		...
		if (ret) {
			dev_err(bq->dev, "%s:mmi_mux close wls mos fail ret=%d",
				__func__, ret);
			return ret;
		}
		udelay(100);
	...
	if (typec_mos == MMI_DVCHG_MUX_CHG_OPEN) {
		ret = regmap_update_bits(bq->regmap, SC8541_CTRL6_REG,
					 SC8541_ENABLE_TYPEC_MOS,
					 SC8541_ENABLE_TYPEC_MOS);
		if (ret) {
			dev_err(bq->dev,
				"%s:mmi_mux open typec mos fail ret=%d",
				__func__, ret);
			return ret;
		}
		...
		if (ret) {
			dev_err(bq->dev, "%s:mmi_mux  en otg fail ret=%d",
				__func__, ret);
			return ret;
		}

		ret = regmap_update_bits(bq->regmap, SC8541_CTRL6_REG,
					 SC8541_ACDRV_MANUAL_EN,
					 SC8541_ACDRV_MANUAL_EN);
		if (ret) {
			dev_err(bq->dev,
				"%s:mmi_mux set acdrv manual fail ret=%d",
				__func__, ret);
			return ret;
		}
		udelay(100);
		...
		if (ret) {
			dev_err(bq->dev,
				"%s:mmi_mux enable otg typec mos fail ret=%d",
				__func__, ret);
			return ret;
		}
#ifdef CONFIG_MOTO_CHANNEL_SWITCH
	...
	if (wls_mos == MMI_DVCHG_MUX_CHG_OPEN) {
		ret = regmap_update_bits(bq->regmap, SC8541_CTRL6_REG,
					 SC8541_ENABLE_WLC_MOS,
					 SC8541_ENABLE_WLC_MOS);
		if (ret) {
			dev_err(bq->dev, "%s:mmi_mux  open wls mux fail ret=%d",
				__func__, ret);
			return ret;
		}
		...
		if (ret) {
			dev_err(bq->dev,
				"%s:mmi_mux menu close wls mos fail ret=%d",
				__func__, ret);
			return ret;
		}
		mdelay(50);
	...
	if (!ret)
		dev_err(bq->dev,
			"%s:mmi_mux Reg SC8541_CHRGR_CTRL_2] = 0x%02X\n",
			__func__, val);
			      ...
			      enum mmi_dvchg_mux_channel wls_mos)
{
	...
	if (typec_mos != MMI_DVCHG_MUX_OTG_OPEN &&
		...
		ret = regmap_update_bits(bq->regmap, BQ25980_CHRGR_CTRL_2,
					 BQ25980_EN_OTG, 0);
		if (ret) {
			dev_err(bq->dev, "mmi_mux close en otg fail ret=%d",
				ret);
			return ret;
		}
	}
	...
	if (typec_mos == MMI_DVCHG_MUX_CLOSE) {
		...
		if (ret) {
			dev_err(bq->dev, "mmi_mux close typec mos fail ret=%d",
				ret);
			return ret;
		}
		udelay(1000);
	...
	if (wls_mos == MMI_DVCHG_MUX_CLOSE) {
		...
		if (ret) {
			dev_err(bq->dev, "mmi_mux close wls mos fail ret=%d",
				ret);
			return ret;
		}
		udelay(1000);
	...
	if (typec_mos == MMI_DVCHG_MUX_CHG_OPEN) {
		...
		if (ret) {
			dev_err(bq->dev, "mmi_mux open mos both fail ret=%d",
				ret);
			return ret;
		}
		ret = regmap_update_bits(bq->regmap, BQ25980_CHRGR_CTRL_2,
					 BQ25980_ENABLE_TYPEC_MOS,
					 BQ25980_ENABLE_TYPEC_MOS);
		if (ret) {
			dev_err(bq->dev, "mmi_mux open typec mos fail ret=%d",
				ret);
			return ret;
		}
	} else if (typec_mos == MMI_DVCHG_MUX_OTG_OPEN) {
		...
		if (ret) {
			dev_err(bq->dev,
				"mmi_mux Reg BQ25980_CHRGR_CTRL_2] fail ret=%d",
				ret);
			return ret;
		}
		...
		if ((val & (BQ25980_ENABLE_TYPEC_MOS | BQ25980_EN_OTG)) !=
			...
			ret = regmap_update_bits(bq->regmap,
						 ...
						 BQ25980_EN_OTG);
			if (ret) {
				dev_err(bq->dev, "mmi_mux  en otg fail ret=%d",
					ret);
				return ret;
			}
			ret = regmap_update_bits(bq->regmap,
						 BQ25980_CHRGR_CTRL_2,
						 BQ25980_DIS_MOS_BOTH,
						 BQ25980_DIS_MOS_BOTH);
			if (ret) {
				dev_err(bq->dev,
					"mmi_mux dis mos both fail ret=%d",
					ret);
				return ret;
			}
			udelay(1000);
			...
			if (ret) {
				dev_err(bq->dev,
					"mmi_mux enable mos both fail ret=%d",
					ret);
				return ret;
			}
			ret = regmap_update_bits(bq->regmap,
			...
			if (ret) {
				dev_err(bq->dev,
					"mmi_mux enable otg typec mos fail ret=%d",
					ret);
				return ret;
			}
		}
		...
		if ((val & (BQ25980_ENABLE_TYPEC_MOS | BQ25980_EN_OTG)) !=
		    (BQ25980_ENABLE_TYPEC_MOS | BQ25980_EN_OTG)) {
			dev_err(bq->dev,
				"mmi_mux into MMI_DVCHG_MUX_OTG_WOPEN");
			ret = regmap_update_bits(bq->regmap,
						 BQ25980_CHRGR_CTRL_2,
						 BQ25980_EN_OTG,
						 BQ25980_EN_OTG);
			...
			ret = regmap_update_bits(
				bq->regmap, BQ25980_CHRGR_CTRL_2,
				BQ25980_DIS_MOS_BOTH | BQ25980_ENABLE_TYPEC_MOS,
				0);
			if (ret) {
				dev_err(bq->dev,
					"mmi_mux enable otg typec mos fail ret=%d",
	...
	if (wls_mos == MMI_DVCHG_MUX_CHG_OPEN ||
		...
		if (ret) {
			dev_err(bq->dev,
				"mmi_mux wls open mos both fail ret=%d", ret);
			return ret;
		}
		ret = regmap_update_bits(bq->regmap, BQ25980_CHRGR_CTRL_2,
					 BQ25980_ENABLE_WLC_MOS,
					 BQ25980_ENABLE_WLC_MOS);
		if (ret) {
			dev_err(bq->dev, "mmi_mux  open wls mux fail ret=%d",
				ret);
			return ret;
		}
	}
	...
	if (typec_mos == MMI_DVCHG_MUX_DISABLE ||
		...
		ret = regmap_update_bits(bq->regmap, BQ25980_CHRGR_CTRL_2,
					 ...
					 BQ25980_DIS_MOS_BOTH);
		if (ret) {
			dev_err(bq->dev, "mmi_mux dis mos both err ret=%d",
				ret);
			return ret;
		}
		udelay(1000);
...
#ifdef CONFIG_MOTO_CHANNEL_SWITCH
static int bq25980_get_vmos_chg(struct charger_device *chg_dev, bool type,
				int *mos_vbus)
{
	struct bq25980_device *bq = charger_get_data(chg_dev);
	if (!bq) {
...
static int bq25980_register_chgdev(struct bq25980_device *bq)
{
	...
	if (bq->mode == BQ_SLAVE)
		bq->chg_dev =
			charger_device_register("secondary_dvchg", bq->dev, bq,
						&bq25980_chg_ops,
						&bq->chg_prop);
	else
			 ...
			 const struct i2c_device_id *id)
{
	...
	if (bq->part_no == SC8541_PART_NO) {
		...
		if (!device_property_read_string(bq->dev, "sc8541-name",
						 &sc8541_name)) {
			len = strlen(sc8541_name);
			strncpy(bq->model_name, sc8541_name,
				min(I2C_NAME_SIZE, len));
		} else
			strncpy(bq->model_name, "sc8541-standalone",
				I2C_NAME_SIZE);
	...
	if (client->irq) {
		ret = devm_request_threaded_irq(
			dev, client->irq, NULL, bq25980_irq_handler_thread,
...
static void bq25980_charger_shutdown(struct i2c_client *client)
{
	...
	/*reg reset*/
	regmap_update_bits(bq->regmap, BQ25980_CHRGR_CTRL_2, BQ25980_REG_RESET,
			   BQ25980_REG_RESET);
	bq25980_set_adc_enable(bq, false);
...
static const struct of_device_id bq25980_of_match[] = {
	{ .compatible = "ti,bq25980-standalone",
	  .data = (void *)BQ25980_STANDALONE },
