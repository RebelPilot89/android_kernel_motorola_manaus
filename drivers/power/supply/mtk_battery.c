...
/* ============================================================ */
int mtk_battery_check_cap_level(int uisoc)
{
	if (uisoc >= 100)
...
EXPORT_SYMBOL(mtk_battery_check_cap_level);
	...
	union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_CAPACITY_LEVEL:
		/* CAMBIO 1: Usar el nuevo nombre unico */
		val->intval = mtk_battery_check_cap_level(bs_data->bat_capacity);
		break;
	case POWER_SUPPLY_PROP_TIME_TO_FULL_NOW:
		/* full or unknown must return 0 */
		/* CAMBIO 2: Usar el nuevo nombre unico */
		ret = mtk_battery_check_cap_level(bs_data->bat_capacity);
	...
	case POWER_SUPPLY_PROP_CHARGE_FULL_DESIGN:
		/* CAMBIO 3: Usar el nuevo nombre unico */
		if (mtk_battery_check_cap_level(bs_data->bat_capacity) ==
