...
#ifndef SYS_PMSEVFR_EL1_RES0
#define SYS_PMSEVFR_EL1_RES0 0
#endif
...
#define SPE_EXT_ATTR_ENTRY(_name, _func, _var)                                 \
	&((struct dev_ext_attribute[]){                                        \
		{ __ATTR(_name, S_IRUGO, _func, NULL), (void *)_var } })[0]    \
		 .attr.attr
...
#define GEN_PMU_FORMAT_ATTR(name)                                              \
	PMU_FORMAT_ATTR(name, _GEN_PMU_FORMAT_ATTR(ATTR_CFG_FLD_##name##_CFG,  \
...
#define ATTR_CFG_GET_FLD(attr, name)                                           \
	_ATTR_CFG_GET_FLD(attr, ATTR_CFG_FLD_##name##_CFG,                     \
			  ATTR_CFG_FLD_##name##_LO, ATTR_CFG_FLD_##name##_HI)
...
static struct attribute *arm_spe_pmu_formats_attr[] = {
	&format_attr_ts_enable.attr,	 &format_attr_pa_enable.attr,
	&format_attr_pct_enable.attr,	 &format_attr_jitter.attr,
	&format_attr_branch_filter.attr, &format_attr_load_filter.attr,
	&format_attr_store_filter.attr,	 &format_attr_event_filter.attr,
	&format_attr_min_latency.attr,	 NULL,
};
...
static int arm_spe_pmu_event_init(struct perf_event *event)
{
	...
	if (!perfmon_capable() && (reg & (BIT(SYS_PMSCR_EL1_PA_SHIFT) |
...
static void __arm_spe_pmu_dev_probe(void *info)
{
	...
	fld = reg >> SYS_PMSIDR_EL1_INTERVAL_SHIFT &
	...
	fld = reg >> SYS_PMSIDR_EL1_COUNTSIZE_SHIFT &
...
MODULE_DESCRIPTION(
	"Perf driver for the ARMv8.2 Statistical Profiling Extension");
