...
#ifdef CONFIG_MTK_IOMMU_EXT
/* Prototipos explícitos si el header falla */
extern char *peri_tf_analyse(int iommu_id, int fault_id);
extern enum peri_iommu get_peri_iommu_id(u32 bus_id);
#else
static inline char *peri_tf_analyse(int iommu_id, int fault_id) { return NULL; }
static inline enum peri_iommu get_peri_iommu_id(u32 bus_id) { return 0; }
#endif
