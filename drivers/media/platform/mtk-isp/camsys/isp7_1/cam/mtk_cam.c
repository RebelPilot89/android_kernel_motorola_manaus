...
static atomic_t mtk_cam_media_link_request_fd = ATOMIC_INIT(-1);
...
static void mtk_cam_register_iommu_tf_callback(struct mtk_raw_device *raw)
{
	...
	if (raw->id == RAW_A) {
		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_IMGP_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_CQI_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_CQI_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_FHO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_AAO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_TSFSO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_FLKO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_RAWI_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_RAWI_R3,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_RAWI_R5,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L16_CAM2_AAI_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L17_CAM3_YUVO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L17_CAM3_YUVO_R3,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L17_CAM3_YUVCO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L17_CAM3_YUVO_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L17_CAM3_RZH1N2TO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L17_CAM3_DRZS4NO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L17_CAM3_TNCSO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);
	} else if (raw->id == RAW_B) {
		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_IMGP_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_CQI_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_CQI_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_FHO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_AAO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_TSFSO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_FLKO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_RAWI_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_RAWI_R3,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_RAWI_R5,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L27_CAM2_AAI_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L29_CAM3_YUVO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L29_CAM3_YUVO_R3,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L29_CAM3_YUVCO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L29_CAM3_YUVO_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L29_CAM3_RZH1N2TO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L29_CAM3_DRZS4NO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L29_CAM3_TNCSO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);
	} else if (raw->id == RAW_C) {
		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_IMGP_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_CQI_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_CQI_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_FHO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_AAO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_TSFSO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_FLKO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_RAWI_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_RAWI_R3,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_RAWI_R5,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L28_CAM2_AAI_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L30_CAM3_YUVO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L30_CAM3_YUVO_R3,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L30_CAM3_YUVCO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L30_CAM3_YUVO_R2,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L30_CAM3_RZH1N2TO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L30_CAM3_DRZS4NO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);

		mtk_iommu_register_fault_callback(
			M4U_PORT_L30_CAM3_TNCSO_R1,
			mtk_cam_translation_fault_callback, (void *)raw, false);
	}
#endif
}
 ...
 */
static void mtk_cam_req_s_data_clean(struct mtk_cam_request_stream_data *s_data)
{
...
static void mtk_cam_req_pipe_s_data_clean(struct mtk_cam_request *req,
					    ...
					    int pipe_id, int index)
{
	...
	if (mtk_cam_is_ext_isp(s_data_pipe->ctx) && is_camsv_subdev(pipe_id) &&
	    buf_state == VB2_BUF_STATE_ERROR) {
		dev_info(cam->dev, "camsv %s:%s: seq:%d FORCED TO DONE\n",
			 __func__, req->req.debug_str,
			 s_data_pipe->frame_seq_no);
		buf_state = VB2_BUF_STATE_DONE;
	}
	dev_dbg(cam->dev, "%s:%s: pipe_id(%d) buf_state(%d) buf_ret_cnt(%d)\n",
		__func__, req->req.debug_str, pipe_id, buf_state, buf_ret_cnt);
...
void mtk_cam_req_update_seq(struct mtk_cam_ctx *ctx,
			    struct mtk_cam_request *req, int seq)
{
					...
					unsigned int frame_seq_no)
{
	...
	req_stream_data =
		mtk_cam_get_req_s_data(ctx, ctx->stream_id, frame_seq_no);
	if (!req_stream_data)
		return NULL;
...
static void update_hw_mapping(struct mtk_cam_ctx *ctx,
			      ...
			      int feature, int hw_mode, int enabled_raw)
{
	int i, exp_no;
	bool bDcif = false;
	...
	config_param->maps[0].dev_mask =
		MTKCAM_SUBDEV_RAW_MASK & ctx->used_raw_dev;
	config_param->n_maps = 1;

	if (mtk_cam_feature_is_stagger(feature) ||
	    mtk_cam_hw_mode_is_dc(hw_mode)) {
		...
		/* update hw maaping */
		for (i = MTKCAM_SUBDEV_CAMSV_START; i < MTKCAM_SUBDEV_CAMSV_END;
		     i++) {
			if (enabled_raw & (1 << i)) {
				if (config_param->n_maps <
				    ARRAY_SIZE(config_param->maps)) {
					config_param->maps[config_param->n_maps]
						.pipe_id = i;
					config_param->maps[config_param->n_maps]
						.dev_mask = (1 << i);
					if (ctx->cam->sv
					...
					dev_info(
						ctx->cam->dev,
						"hw mapping pipe_id:%d exp_order:%d",
						i,
						config_param
							->maps[config_param
								       ->n_maps]
					...
					dev_info(
						ctx->cam->dev,
						"hw mapping is over size(enable_raw:%d)",
					 ...
					 int pipe_id)
{
	...
	dev_dbg(ctx->cam->dev,
		...
		ctx->stream_id, req->ctx_used, ctx->cam->streaming_ctx, pipe_id,
		req->pipe_used, ctx->cam->streaming_pipe, req->done_status);
			  ...
			  int node_id)
{
	...
	vb = &buf->vbb.vb2_buf;
	if (!vb) {
		dev_info(ctx->cam->dev, "%s:ctx(%d): can't get vb2 buf\n",
	...
	if (!vaddr) {
		dev_info(ctx->cam->dev, "%s:ctx(%d): can't get plane_vadd\n",
			 __func__, ctx->stream_id);
		return NULL;
	}
	return vaddr;
			   ...
			   struct mtk_cam_request_stream_data *s_data)
{
	...
	if (ctx->used_raw_num != 0)
		subsample = mtk_cam_get_subsample_ratio(
	...
	if ((s_data->working_buf->buffer.va == (void *)NULL) ||
		...
		dev_info(ctx->cam->dev, "%s:ctx(%d): can't get working_buf\n",
			 __func__, ctx->stream_id);
		return;
	}

	fho_va = (u32 *)(s_data->working_buf->buffer.va +
			 s_data->working_buf->buffer.size -
			 64 * (subsample + 1));
	...
	for (i = 0; i < (subsample + 1); i++) {
		...
		*(pTimestamp + i * 2) =
			mtk_cam_timesync_to_monotonic(
				(u64)(*(fho_va + i * 16)) +
				((u64)(*(fho_va + i * 16 + 1)) << 32)) /
			1000;
		*(pTimestamp + i * 2 + 1) =
			mtk_cam_timesync_to_boot(
				(u64)(*(fho_va + i * 16)) +
				((u64)(*(fho_va + i * 16 + 1)) << 32)) /
			1000;
		dev_dbg(ctx->cam->dev,
...
int mtk_cam_dequeue_req_frame(struct mtk_cam_ctx *ctx,
			      unsigned int dequeued_frame_seq_no, int pipe_id)
{
	struct mtk_cam_request *req, *req_prev;
	...
	spin_lock(&ctx->cam->running_job_lock);
	list_for_each_entry_safe (req, req_prev, &ctx->cam->running_job_list,
				  list) {
		if (!(req->pipe_used & (1 << pipe_id)))
			continue;
...
STOP_SCAN:
	...
	for (handled_cnt = 0; handled_cnt < s_data_cnt; handled_cnt++) {
		...
		if (is_raw_subdev(pipe_id))
			vaddr = mtk_cam_get_vbuf_va(ctx, s_data,
						    MTK_RAW_META_OUT_0);
		...
		if (is_raw_subdev(pipe_id) && debug_ae) {
			...
			dev_info(
				...
				__func__, req->req.debug_str, ctx->stream_id,
				pipe_id, dequeued_frame_seq_no,
				s_data->frame_seq_no, req->done_status,
				req->pipe_used, ctx->streaming_pipe,
				ctx->cam->streaming_pipe, del_job, del_req,
				vaddr, pipe->res_config.sink_fmt.width,
		...
		if (s_data->frame_seq_no < dequeued_frame_seq_no) {
			...
			buf_state = VB2_BUF_STATE_DONE;
			dev_dbg(ctx->cam->dev,
				"%s:%s:pipe(%d) seq:%d, done success", __func__,
				req->req.debug_str, pipe_id,
				s_data->frame_seq_no);
		}
				   ...
				   int buf_state)
{
	...
	list_for_each_entry_safe (req, req_prev, &req_clean_list,
				  cleanup_list) {
	...
	for (handled_cnt = 0; handled_cnt < s_data_cnt; handled_cnt++) {
		...
		if (other_pipes) {
			for (i = 0; i < MTKCAM_SUBDEV_MAX; i++) {
				 ...
				 */
				if (flush_work(
					    &s_data_pipe->frame_done_work.work))
					dev_info(
						cam->dev,
						"%s:%s:pipe(%d):seq(%d): flush pipe(%d) frame_done_work\n",
						__func__, req->req.debug_str,
						pipe_id,
						s_data_pipe->frame_seq_no, i);
			}
		}
...
static void
config_img_in_fmt_mstream(struct mtk_cam_device *cam,
			  struct mtk_cam_request_stream_data *req_stream_data,
			  struct mtk_cam_video_device *node,
			  const struct v4l2_format *cfg_fmt, int feature)
{
	...
	if (mtk_cam_feature_is_m2m(feature)) {
		...
		for (exp = 1; exp <= 3; exp++) {
			if (exp == 1) {
				req_stream_data = mtk_cam_req_get_s_data(
					req, ctx->stream_id, 1);
			...
			dev_dbg(cam->dev,
				...
				req_stream_data->frame_params.img_outs[0]
					.buf[0][0]
					.iova);
		}
	} else {
		input_node = MTKCAM_IPI_RAW_RAWI_2;
		in_fmt = &req_stream_data->frame_params
				  .img_ins[input_node - MTKCAM_IPI_RAW_RAWI_2];
		in_fmt->uid.id = input_node;
		in_fmt->uid.pipe_id = node->uid.pipe_id;
		in_fmt->fmt.format =
				      ...
				      int feature, s64 hw_mode)
{
	...
	static const int stagger_dcif_1exp_rawi[1] = { MTKCAM_IPI_RAW_RAWI_5 };
	static const int stagger_dcif_2exp_rawi[2] = { MTKCAM_IPI_RAW_RAWI_2,
						       MTKCAM_IPI_RAW_RAWI_5 };
	static const int stagger_dcif_3exp_rawi[3] = { MTKCAM_IPI_RAW_RAWI_2,
						       MTKCAM_IPI_RAW_RAWI_3,
						       MTKCAM_IPI_RAW_RAWI_5 };
	static const int stagger_m2m_2exp_rawi[2] = { MTKCAM_IPI_RAW_RAWI_2,
						      MTKCAM_IPI_RAW_RAWI_6 };
	static const int stagger_m2m_3exp_rawi[3] = { MTKCAM_IPI_RAW_RAWI_2,
						      MTKCAM_IPI_RAW_RAWI_3,
						      MTKCAM_IPI_RAW_RAWI_6 };
	...
	for (rawi_idx = 0; rawi_idx < rawi_port_num; rawi_idx++) {
		...
		dev_dbg(cam->dev,
			...
			rawi_idx, req->ctx->stream_id, input_node,
			in_fmt->fmt.s.w, in_fmt->fmt.s.h, in_fmt->fmt.stride[0],
			in_fmt->fmt.format, in_fmt->buf[0].iova);
	}
}

static void config_img_in_fmt_time_shared(
	struct mtk_cam_device *cam, struct mtk_cam_request_stream_data *req,
	struct mtk_cam_video_device *node, const struct v4l2_format *cfg_fmt)
{
	struct mtkcam_ipi_img_input *in_fmt;
	...
	node = &ctx->pipe->vdev_nodes[MTK_RAW_MAIN_STREAM_OUT -
				      MTK_RAW_SINK_NUM];
	in_fmt->uid.id = input_node;
	in_fmt->uid.pipe_id = node->uid.pipe_id;
	in_fmt->fmt.format =
	...
	dev_info(
		...
		in_fmt->fmt.s.w, in_fmt->fmt.s.h, in_fmt->buf[0].size,
		in_fmt->fmt.stride[0], in_fmt->fmt.format, in_fmt->buf[0].iova);
}
static void check_buffer_mem_saving(struct mtk_cam_request_stream_data *req,
				    struct mtkcam_ipi_img_input *in_fmt,
				    int rawi_port_num)
{
				 ...
				 struct mtk_cam_request *cam_req)
{
	...
	for (rawi_idx = 0; rawi_idx < rawi_port_num; rawi_idx++) {
		...
		if (in_fmt->buf[0].iova == 0x0) {
			...
			cfg_fmt =
				mtk_cam_s_data_get_vfmt(s_data, node->desc.id);
			...
			in_fmt->fmt.stride[0] =
				fmt_for_rawi->fmt.pix_mp.plane_fmt[0]
					.bytesperline;
			/* prepare working buffer */
			buf_entry = mtk_cam_img_working_buf_get(ctx);
			if (!buf_entry) {
			     ...
			     struct mtkcam_ipi_img_input *in_fmt)
{
	...
	in_fmt->fmt.s.h = cfg_fmt->fmt.pix_mp.height;
	in_fmt->fmt.stride[0] = cfg_fmt->fmt.pix_mp.plane_fmt[0].bytesperline;
	dev_dbg(cam->dev, "pipe: %d dma_port:%d size=%0dx%0d, stride:%d\n",
			  ...
			  int sd_height)
{
	...
	if (node->desc.dma_port == MTKCAM_IPI_RAW_IMGO &&
		...
		dev_dbg(cam->dev,
			"pipe: %d cfg(%d,%d) size is larger than sensor(%d,%d)\n",
			node->uid.pipe_id, cfg_fmt->fmt.pix_mp.width,
			cfg_fmt->fmt.pix_mp.height, sd_width, sd_height);
		return -EINVAL;
	}
...
static int config_img_fmt_mstream(struct mtk_cam_ctx *ctx,
				  ...
				  const struct v4l2_format *cfg_fmt,
				  struct mtk_cam_video_device *node,
				  int sd_width, int sd_height, int feature)
{
	struct mtk_cam_device *cam = ctx->cam;
	struct mtk_cam_request_stream_data *req_stream_data;
	...
	mstream_first_out_fmt =
		&mstream_req_stream_data->frame_params
	...
	ret = config_img_fmt(cam, node, cfg_fmt, mstream_first_out_fmt,
			     sd_width, sd_height);
	if (ret)
		return ret;
				 ...
				 struct mtk_cam_request *req)
{
	...
	if (in_fmt->buf[0].iova == 0x0) {
		...
		/* config format */
		vdev = &pipe->vdev_nodes[MTK_RAW_MAIN_STREAM_OUT -
					 MTK_RAW_SINK_NUM];
		cfg_fmt = mtk_cam_s_data_get_vfmt(req_stream_data,
	...
	for (i = MTK_RAW_SINK_NUM + 1; i < MTK_RAW_META_OUT_BEGIN; i++) {
		...
		if (!f) {
			...
			if (s_data->vdev_fmt_update & (1 << node->desc.id)) {
				mtk_cam_video_set_fmt(
					node, f, s_data->feature.raw_feature);
				node->active_fmt = *f;
				dev_dbg(cam->dev,
				    ...
				    int pipe_id)
{
	...
	if (res_user->sensor_res.cust_pixel_rate)
		...
		prate = mtk_cam_seninf_calc_pixelrate(
			cam->dev, sink_fmt->width, sink_fmt->height,
	...
	if (mtk_cam_feature_is_stagger(res_cfg->raw_feature)) {
		if (mtk_cam_feature_is_2_exposure(res_cfg->raw_feature)) {
			dev_info(
				...
				__func__, pipe_id, res_cfg->raw_feature, prate,
				prate * 2);
			prate = 2 * prate;
		} else if (mtk_cam_feature_is_3_exposure(
				   res_cfg->raw_feature)) {
			dev_info(
				cam->dev,
	...
	mtk_raw_resource_calc(cam, res_cfg, prate, res_cfg->res_plan, fps,
			      sink_fmt->width, sink_fmt->height, &width,
			      &height);
		...
		if (req->pipe_used & (1 << pipe_id)) {
			if (is_raw_subdev(pipe_id)) {
				...
				if (stream_data->pad_fmt_update &
					...
					w = raw_pipeline->cfg[MTK_RAW_SINK]
						    .mbus_fmt.width;
					h = raw_pipeline->cfg[MTK_RAW_SINK]
						    .mbus_fmt.height;
					if (w != stream_data->pad_fmt[pad]
							    .format.width ||
					    h != stream_data->pad_fmt[pad]
							    .format.height) {
						dev_info(
							cam->dev,
				...
				raw_pipe_data =
					mtk_cam_s_data_get_raw_pipe_data(
						stream_data);
				if (raw_pipe_data) {
					if (req->ctx_link_update &
						...
						sink_fmt =
							&stream_data
								 ->pad_fmt[MTK_RAW_SINK]
								 .format;
						mtk_cam_calc_pending_res(
							cam,
							&raw_pipeline
								 ->res_config,
							&raw_pipe_data->res,
					...
					raw_pipe_data->res_config =
						raw_pipeline->res_config;
				} else {
					dev_info(cam->dev,
						 "%s:no raw_pipe_data found!\n",
						 __func__);
				}
				...
				sv_pipeline =
					&cam->sv.pipelines
						 [pipe_id -
						  MTKCAM_SUBDEV_CAMSV_START];
				mtk_cam_req_set_sv_vfmt(cam, sv_pipeline,
							stream_data);
				...
				if (stream_data->pad_fmt_update & (1 << pad)) {
					mtk_mraw_call_pending_set_fmt(
						sd, &stream_data->pad_fmt[pad]);
					mtk_cam_mraw_update_param(
						&stream_data->frame_params,
						&cam->mraw.pipelines
							 [pipe_id -
							  MTKCAM_SUBDEV_MRAW_START]);
					mtk_cam_mraw_cal_cfg_info(
						cam, pipe_id, stream_data, 1);
				}
			}
		}
	}
				   ...
				   struct mtk_cam_request_stream_data *s_data)
{
	...
	dev_dbg(raw_pipe->subdev.v4l2_dev->dev,
		...
		__func__, raw_pipe->subdev.name, debug_str,
		s_data->feature.raw_feature, s_data->feature.prev_feature,
		s_data->feature.switch_feature_type,
				      ...
				      struct mtk_cam_mstream_exposure *exp)
{
	...
	dev_dbg(ctx->cam->dev,
		...
		raw_feature, req_stream_data_1st->mtk_cam_exposure.shutter,
	...
	if (is_mtk_format(pixelformat)) {
		...
		if (info->mem_planes == 1) {
			if (is_yuv_ufo(pixelformat)) {
				...
				img_out->fmt.stride[0] = aligned_width *
							 info->bit_r_num /
							 info->bit_r_den;
				img_out->buf[0][0].size =
					img_out->fmt.stride[0] * height;
				img_out->buf[0][0].size +=
					img_out->fmt.stride[0] * height / 2;
				img_out->buf[0][0].size +=
					ALIGN((aligned_width / 64), 8) * height;
				img_out->buf[0][0].size +=
					ALIGN((aligned_width / 64), 8) *
					height / 2;
				img_out->buf[0][0].size +=
					sizeof(struct UfbcBufferHeader);

				pr_debug(
					"plane:%d stride:%d plane_size:%d addr:0x%x\n",
...
void mtk_cam_mstream_buf_update(struct mtk_cam_request *req,
				...
				unsigned int desc_id, int buf_plane_idx,
				struct vb2_buffer *vb,
		...
		if ((feature & MSTREAM_NE_SE) == MSTREAM_NE_SE) {
			if (i == 0) {
				if (node->desc.id == MTK_RAW_MAIN_STREAM_OUT) {
					...
					// 3. 1st exp NE output
					mstream_frame_param->img_outs[desc_id]
						.buf[0][0]
						.iova = buf->daddr;
					mstream_frame_param->img_outs[desc_id]
						.buf[0][0]
						.size =
						f->fmt.pix_mp.plane_fmt[0]
							.sizeimage;

					// SE output
					frame_param->img_outs[desc_id]
						.buf[0][0]
						.iova =
						buf->daddr +
						f->fmt.pix_mp.plane_fmt[0]
					...
					pr_debug(
						"mstream ne_se m2m ne imgo:0x%x size:%d se imgo:0x%x size:%d\n",
						mstream_frame_param
							->img_outs[desc_id]
							.buf[0][0]
							.iova,
					...
					pr_debug(
						"mstream ne_se m2m se rawi2:0x%x size:%d\n",
						frame_param
							->img_ins[in_node -
								  MTKCAM_IPI_RAW_RAWI_2]
							.buf[0]
					...
					pr_debug(
						"mstream ne_se m2m ne rawi2:0x%x size:%d\n",
						mstream_frame_param
							->img_ins[in_node -
								  MTKCAM_IPI_RAW_RAWI_2]
							.buf[0]
				...
				if (node->desc.id == MTK_RAW_MAIN_STREAM_OUT) {
					...
					pr_debug(
						"mstream ne_se m2m se rawi6:0x%x size:%d\n",
						frame_param
							->img_ins[in_node -
								  MTKCAM_IPI_RAW_RAWI_2]
							.buf[0]
			...
			if (i == 0) {
				if (node->desc.id == MTK_RAW_MAIN_STREAM_OUT) {
					...
					pr_debug(
						"mstream se_ne m2m se imgo:0x%x size:%d ne imgo:0x%x size:%d\n",
						mstream_frame_param
							->img_outs[desc_id]
							.buf[0][0]
							.iova,
					...
					pr_debug(
						"mstream se_ne m2m ne rawi2:0x%x size:%d\n",
						frame_param
							->img_ins[in_node -
								  MTKCAM_IPI_RAW_RAWI_2]
							.buf[0]
					...
					pr_debug(
						"mstream se_ne m2m se rawi2:0x%x size:%d\n",
						mstream_frame_param
							->img_ins[in_node -
								  MTKCAM_IPI_RAW_RAWI_2]
							.buf[0]
				...
				if (node->desc.id == MTK_RAW_MAIN_STREAM_OUT) {
					...
					pr_debug(
						"mstream se_ne m2m ne rawi6:0x%x size:%d\n",
						frame_param
							->img_ins[in_node -
								  MTKCAM_IPI_RAW_RAWI_2]
							.buf[0]
		...
		if ((feature & MSTREAM_NE_SE) == MSTREAM_NE_SE) {
			if (i == 0) { // normal output NE(plane[0]) first
				...
				frame_param->img_outs[desc_id].buf[0][0].size =
					f->fmt.pix_mp.plane_fmt[i].sizeimage;
				pr_debug(
					"mstream ne_se se rawi:0x%x size:%d, imgo:0x%x size:%d\n",
					frame_param
						->img_ins[in_node -
							  MTKCAM_IPI_RAW_RAWI_2]
						.buf[0]
			...
			if (i == 0) { // normal output SE(plane[1]) first
				...
				frame_param->img_outs[desc_id].buf[0][0].size =
					f->fmt.pix_mp.plane_fmt[i].sizeimage;
				pr_debug(
					"mstream se_ne ne rawi:0x%x size:%d, imgo:0x%x size:%d\n",
					frame_param
						->img_ins[in_node -
							  MTKCAM_IPI_RAW_RAWI_2]
						.buf[0]
...
int mtk_cam_hdr_buf_update(struct vb2_buffer *vb, enum hdr_scenario_id scenario,
				    ...
				    struct mtk_cam_buffer *buf)
{
	...
	if (raw_pipline->res_config.raw_path ==
	    V4L2_MTK_CAM_RAW_PATH_SELECT_BPC)
		frame_param->raw_param.imgo_path_sel =
			MTKCAM_IPI_IMGO_AFTER_BPC;
	else if (raw_pipline->res_config.raw_path ==
		 V4L2_MTK_CAM_RAW_PATH_SELECT_FUS)
		frame_param->raw_param.imgo_path_sel =
			MTKCAM_IPI_IMGO_AFTER_FUS;
	else if (raw_pipline->res_config.raw_path ==
		 V4L2_MTK_CAM_RAW_PATH_SELECT_DGN)
		frame_param->raw_param.imgo_path_sel =
			MTKCAM_IPI_IMGO_AFTER_DGN;
	else if (raw_pipline->res_config.raw_path ==
		 V4L2_MTK_CAM_RAW_PATH_SELECT_LSC)
		frame_param->raw_param.imgo_path_sel =
			MTKCAM_IPI_IMGO_AFTER_LSC;
	else if (raw_pipline->res_config.raw_path ==
		 V4L2_MTK_CAM_RAW_PATH_SELECT_LTM)
		frame_param->raw_param.imgo_path_sel =
	...
	dev_dbg(cam->dev,
		"%s: node:%d fd:%d idx:%d raw_path(%d) ipi imgo_path_sel(%d))\n",
		__func__, node->desc.id, buf->vbb.request_fd,
		buf->vbb.vb2_buf.index, raw_pipline->res_config.raw_path,
		frame_param->raw_param.imgo_path_sel);
}
 ...
 */
static int
mtk_cam_config_raw_img_out_imgo(struct mtk_cam_request_stream_data *s_data,
				struct mtk_cam_buffer *buf)
{
	...
	if ((feature & MTK_CAM_FEATURE_HDR_MASK) &&
		...
		mtk_cam_hdr_buf_update(vb, MSTREAM_M2M, req, node->uid.pipe_id,
				       feature, cfg_fmt);
	}
	...
	if (feature & MTK_CAM_FEATURE_SUBSAMPLE_MASK) {
		...
		if (feature == HIGHFPS_16_SUBSAMPLE)
			for (i = MAX_SUBSAMPLE_PLANE_NUM; i < 16; i++)
				img_out->buf[i][0].iova =
					buf->daddr +
					i * cfg_fmt->fmt.pix_mp.plane_fmt[0]
							.sizeimage;
...
static int
mtk_cam_config_raw_img_out(struct mtk_cam_request_stream_data *s_data,
			   struct mtk_cam_buffer *buf)
{
	struct mtk_cam_ctx *ctx;
	struct mtk_cam_device *cam;
	...
	if (feature & MTK_CAM_FEATURE_SUBSAMPLE_MASK) {
		...
		if (feature == HIGHFPS_16_SUBSAMPLE) {
			for (i = MAX_SUBSAMPLE_PLANE_NUM; i < 16; i++) {
				offset = i * cfg_fmt->fmt.pix_mp.plane_fmt[0]
						     .sizeimage;
				img_out->buf[i][0].iova = buf->daddr + offset;
				img_out->buf[i][0].size =
					img_out->buf[0][0].size;
			   ...
			   struct mtk_cam_buffer *buf)
{
	...
	if (mtk_cam_feature_is_stagger(feature) ||
		...
		config_img_in_fmt_stagger(cam, s_data, node, cfg_fmt, feature,
	...
	if ((mtk_cam_feature_is_mstream(feature) ||
		...
		ret = config_img_fmt_mstream(ctx, req, cfg_fmt, node, sd_width,
					     sd_height, feature);
		if (ret)
			return ret;
	}
				...
				struct mtk_cam_buffer *buf)
{
	...
	if (feature & MTK_CAM_FEATURE_OFFLINE_M2M_MASK &&
		...
		if (mtk_cam_feature_is_stagger_m2m(feature)) {
			mtk_cam_hdr_buf_update(vb, STAGGER_M2M, req,
					       node->uid.pipe_id, feature,
					       cfg_fmt);
			frame_param->raw_param.hardware_scenario =
				MTKCAM_IPI_HW_PATH_OFFLINE_STAGGER;
			    ...
			    struct mtk_cam_buffer *buf)
{
	...
	if (s_data->vdev_fmt_update && cfg_fmt) {
		mtk_cam_sv_cal_cfg_info(ctx, cfg_fmt, &s_data->sv_frame_params);
			      ...
			      struct mtk_cam_request *req)
{
	...
	list_for_each_entry_safe (obj, obj_prev, &req->req.objects, list) {
		...
		if (ctx->used_raw_num && node->desc.id == MTK_RAW_META_OUT_1) {
			...
			if (ctx->pipe->res_config.raw_num_used == 1 &&
				...
				req_stream_data->flags |=
					MTK_CAM_REQ_S_DATA_FLAG_META1_INDEPENDENT;
			} else {
				dev_dbg(cam->dev,
		...
		case MTKCAM_IPI_RAW_RAWI_2:
			ret = mtk_cam_config_raw_img_in_rawi2(req_stream_data,
							      buf);
			if (ret)
				return ret;
			break;
		case MTKCAM_IPI_RAW_IMGO:
			...
			ret = mtk_cam_config_raw_img_out_imgo(req_stream_data,
							      buf);
			if (ret)
				return ret;
		...
		if (ctx->pipe) {
			if (ctx->pipe->fs_config & MTK_RAW_CTRL_UPDATE) {
				...
				dev_info(
					...
					__func__, req->req.debug_str,
					ctx->stream_id, ctx->pipe->fs_config,
					req->fs.update_ctx,
					req->fs.update_value);
			}
		}
				...
				struct mtk_cam_request *req)
{
	...
	req_stream_data_mstream->sensor_hdl_obj =
		req_stream_data->sensor_hdl_obj;
	req_stream_data_mstream->flags |=
		req_stream_data->flags & MTK_CAM_REQ_S_DATA_FLAG_SENSOR_HDL_EN;
	req_stream_data_mstream->flags |=
		req_stream_data->flags & MTK_CAM_REQ_S_DATA_FLAG_RAW_HDL_EN;
	...
	for (j = MTKCAM_SUBDEV_RAW_START; j < MTKCAM_SUBDEV_RAW_END; j++) {
		if (1 << j & ctx->streaming_pipe) {
			...
			mtk_cam_req_work_init(frame_done_work,
					      pipe_stream_data);
			INIT_WORK(&frame_done_work->work,
				  mtk_cam_frame_done_work);
		}
	}
}
				   ...
				   unsigned int pipe_id)
{
	...
	req_stream_data->frame_seq_no =
		req_stream_data_mstream->frame_seq_no + 1;
	atomic_set(&cam->ctxs[pipe_id].enqueued_frame_seq_no,
		   req_stream_data->frame_seq_no);
	...
	/* sv parameters */
	req_stream_data_mstream->sv_frame_params =
		req_stream_data->sv_frame_params;
			  ...
			  struct mtk_cam_request_stream_data *s_data)
{
	...
	if (req->ctx_link_update &&
	    (!s_data->seninf_new || !s_data->seninf_old)) {
		dev_info(
			ctx->cam->dev,
...
static void mtk_cam_req_s_data_init(struct mtk_cam_request *req, int pipe_id,
				    int s_data_index)
{
	struct mtk_cam_request_stream_data *req_stream_data;
	...
	list_for_each_entry_safe (req, req_prev, &cam->pending_job_list, list) {
		if (likely(mtk_cam_dev_req_is_stream_on(cam, req))) {
			if (job_count + enqueue_req_cnt >=
				...
				dev_dbg(cam->dev,
					"jobs are full, job cnt(%d)\n",
					job_count);
				break;
			}
			dev_dbg(cam->dev,
				"%s job cnt(%d), allow req_enqueue(%s)\n",
				__func__, job_count + enqueue_req_cnt,
				req->req.debug_str);
	...
	list_for_each_entry_safe (req, req_prev, &equeue_list, list) {
		for (i = 0; i < cam->max_stream_num; i++) {
			...
			if (is_raw_subdev(i) && ctx->sensor) {
				...
				s_data_cnt = atomic_inc_return(
					&ctx->running_s_data_cnt);
				...
				list_for_each_entry (obj, &req->req.objects,
						     list) {
					if (vb2_request_object_is_buffer(obj))
						continue;

					hdl = (struct v4l2_ctrl_handler *)
						      obj->priv;
					if (hdl == &ctx->pipe->ctrl_handler)
						raw_hdl_obj = obj;
					else if (hdl ==
						 ctx->sensor->ctrl_handler)
						sensor_hdl_obj = obj;
				}
				...
				if (mtk_cam_feature_change_is_mstream(
				    ...
				    (req->ctx_link_update &
				     (1 << ctx->pipe->id)))
					mstream_seamless_buf_update(
						ctx, req, i, previous_feature);
...
static void mtk_cam_req_p_data_init(struct mtk_cam_request *req, int pipe_id,
				    int s_data_num)
{
	int i = 0;
			       ...
			       unsigned int notification)
{
	...
	struct mtk_cam_ctx *ctx;
	struct mtk_cam_device *cam;
	int request_fd = atomic_xchg(&mtk_cam_media_link_request_fd, -1);
	...
	cam = container_of(subdev->v4l2_dev->mdev, struct mtk_cam_device,
			   media_dev);
	...
	stream_data->sensor =
		mtk_cam_find_sensor(ctx, &stream_data->seninf_new->entity);
	cam_req->ctx_link_update |= 1 << ctx->stream_id;
	media_request_put(req);

	dev_dbg(cam->dev,
		"link_change ctx:%d, req:%s, old seninf:%s, new seninf:%s\n",
		ctx->stream_id, req->debug_str, stream_data->seninf_old->name,
...
static int get_available_sv_pipes(struct mtk_cam_device *cam, int hw_scen,
				  int req_amount, int master, int is_trial)
{
		...
		for (i = 0; i < CAMSV_GROUP_AMOUNT; i++) {
			for (j = 0; j < req_amount; j++) {
				...
				for (k = 0; k < cam->num_camsv_drivers; k++) {
					if ((cam->sv.pipelines[k].is_occupied ==
					     0) &&
					    (cam->sv.pipelines[k].hw_cap &
					     hw_scen) &&
					    (cam->sv.pipelines[k].hw_cap &
					     group) &&
					    (cam->sv.pipelines[k].hw_cap &
				 ...
				 int prev_feature)
{
	...
	vdev = &ctx->pipe->vdev_nodes[MTK_RAW_MAIN_STREAM_OUT -
				      MTK_RAW_SINK_NUM];
	...
	if (current_feature == MSTREAM_NE_SE) {
		...
		// SE, in = NE output
		frame_param->img_ins[in_node - MTKCAM_IPI_RAW_RAWI_2]
			.buf[0]
			.iova =
			mstream_frame_param->img_outs[desc_id].buf[0][0].iova;
		frame_param->img_ins[in_node - MTKCAM_IPI_RAW_RAWI_2]
...
int get_main_sv_pipe_id(struct mtk_cam_device *cam, int used_dev_mask)
{
	...
	for (i = MTKCAM_SUBDEV_CAMSV_START; i < MTKCAM_SUBDEV_CAMSV_END; i++) {
		if (used_dev_mask & (1 << i))
			if (cam->sv.pipelines[i - MTKCAM_SUBDEV_CAMSV_START]
				    .exp_order == 0)
				return i;
	}
	return -1;
				      ...
				      unsigned int enabled_raw)
{
	...
	if (i == num_raw_drivers)
		pr_info("no master raw id found, enabled_raw 0x%x",
			enabled_raw);
...
{
	unsigned int i =
		get_master_raw_id(cam->num_raw_drivers, pipe->enabled_raw);
					 ...
					 struct mtk_raw_pipeline *pipe)
{
	...
	for (i = 0; i + 1 < cam->num_raw_drivers; i++) {
					  ...
					  struct mtk_raw_pipeline *pipe)
{
	...
	for (i = 0; i + 2 < cam->num_raw_drivers; i++) {
		if (pipe->enabled_raw & (1 << i)) {
...
bool mtk_cam_is_immediate_switch_req(struct mtk_cam_request *req, int stream_id)
{
				   ...
				   struct mtkcam_ipi_event *ipi_msg)
{
	...
	struct mtk_mraw_working_buf_entry
		*mraw_buf_entry[MAX_MRAW_PIPES_PER_STREAM];
	struct mtk_cam_request_stream_data *s_data;
	struct mtk_cam_request *req;
	...
	buf_entry =
		list_first_entry(&ctx->using_buffer_list.list,
				 struct mtk_cam_working_buf_entry, list_entry);
	list_del(&buf_entry->list_entry);
	...
	if (mtk_cam_is_immediate_switch_req(req, s_data->pipe_id)) {
		if (mtk_cam_is_mstream(ctx)) {
			...
			mstream_1st_data =
				mtk_cam_req_get_s_data(req, ctx->stream_id, 1);
			if (ipi_msg->cookie.frame_no ==
			    mstream_1st_data->frame_seq_no) {
	...
	buf_entry->cq_desc_size = ipi_msg->ack_data.frame_result.cq_desc_size;
	...
	if (mtk_cam_feature_is_mstream(s_data->feature.raw_feature) ||
		...
		mstream_s_data =
			mtk_cam_req_get_s_data(s_data->req, ctx->stream_id, 0);
	...
	for (i = 0; i < ctx->used_mraw_num; i++) {
		spin_lock(&ctx->mraw_using_buffer_list[i].lock);
		mraw_buf_entry[i] =
			list_first_entry(&ctx->mraw_using_buffer_list[i].list,
					 struct mtk_mraw_working_buf_entry,
					 list_entry);
	...
	if (mtk_cam_is_ext_isp(ctx) && ctx->ext_isp_meta_off &&
	    ctx->ext_isp_pureraw_off) {
		if (mtk_cam_is_ext_isp_yuv(ctx)) {
			s_data->state.estate = E_STATE_EXTISP_SV_INNER;
			dev_info(
				dev,
				"only porc yuv req:%d [E_STATE_EXTISP_SV_INNER]\n",
				s_data->frame_seq_no);
		} else
			ctx->pipe->feature_active = 0x0;
	}
	if ((ctx->composed_frame_seq_no == 1 && !mtk_cam_is_ext_isp(ctx) &&
		...
		apply_cq(raw_dev, 1, buf_entry->buffer.iova,
			 buf_entry->cq_desc_size, buf_entry->cq_desc_offset,
			 buf_entry->sub_cq_desc_size,
			 buf_entry->sub_cq_desc_offset);

		if (mtk_cam_is_with_w_channel(ctx)) {
			if (mtk_cam_sv_rgbw_apply_next_buffer(
				    buf_entry->s_data) == 0)
				dev_info(raw_dev->dev,
					 "rgbw: sv apply next buffer failed");
		}
		...
		for (i = 0; i < ctx->used_mraw_num; i++) {
			...
			if (mraw_buf_entry[i]->s_data->req->pipe_used &
				...
				apply_mraw_cq(
					...
					mraw_buf_entry[i]->mraw_cq_desc_size,
					mraw_buf_entry[i]->mraw_cq_desc_offset,
					(ctx->composed_frame_seq_no == 1) ? 1 :
									    0);
			} else {
				if (watchdog_scenario(ctx))
					mtk_ctx_watchdog_stop(
						ctx,
						mraw_dev->id +
							MTKCAM_SUBDEV_MRAW_START,
						0);
	...
	if (mtk_cam_is_ext_isp(ctx) && ctx->composed_frame_seq_no == 1) {
...
static int isp_composer_handler(struct rpmsg_device *rpdev, void *data, int len,
				void *priv, u32 src)
{
	...
	if (ipi_msg->ack_data.ack_cmd_id == CAM_CMD_FRAME) {
		...
		dev_info(dev, "%s:ctx(%d): session destroyed", __func__,
			 ctx->stream_id);
	}
...
static void isp_tx_frame_worker(struct work_struct *work)
{
	...
	meta1_buf =
		mtk_cam_s_data_get_vbuf(req_stream_data, MTK_RAW_META_OUT_1);

#ifdef SUPPORT_AFO_MEMCPY
	if (req_stream_data->flags &
		    MTK_CAM_REQ_S_DATA_FLAG_META1_INDEPENDENT &&
	    meta1_buf) {
		/* replace the video buffer with ccd buffer*/
		frame_param = &req_stream_data->frame_params;
		meta_1_out = &frame_param->meta_outputs[MTK_RAW_META_OUT_1 -
	...
	for (i = 0; i < ctx->used_mraw_num; i++) {
		...
		req_stream_data_mraw = mtk_cam_req_get_s_data(
			req, ctx->mraw_pipe[i]->id, req_stream_data->index);
		mraw_buf_entry = mtk_cam_mraw_working_buf_get(ctx);
		if (!mraw_buf_entry) {
			dev_info(
				cam->dev,
				"%s: No Mraw working buf availablle: req:%d(%s)\n",
				__func__, req_stream_data->frame_seq_no,
				req->req.debug_str);
			WARN_ON(1);
			return;
		}
		mtk_cam_mraw_wbuf_set_s_data(mraw_buf_entry,
		...
		req_stream_data_mraw->frame_seq_no =
			req_stream_data->frame_seq_no;
		...
		dev_dbg(cam->dev,
			"%s: idx:%d mraw pipe id:%d tg_w:%d tg_h:%d pixel_mode:%d\n",
	...
	imgo_out_fmt =
		&req_stream_data->frame_params.img_outs[MTK_RAW_MAIN_STREAM_OUT -
							MTK_RAW_SOURCE_BEGIN];
	...
	if (ctx->rpmsg_dev) {
		...
		dev_dbg(cam->dev,
			"%s: rpmsg_dev not exist: %d, ctx:%d, req:%d\n",
...
void mtk_cam_sensor_switch_stop_reinit_hw(
	struct mtk_cam_ctx *ctx, struct mtk_cam_request_stream_data *s_data,
	int stream_id)
{
	struct mtk_cam_device *cam = ctx->cam;
	struct mtk_cam_request *req;
	...
	if (!s_raw_pipe_data) {
		dev_info(cam->dev,
			 "%s: failed to get raw_pipe_data (pipe:%d, seq:%d)\n",
	...
	dev_info(
		...
		__func__, req->req.debug_str, s_data->pipe_id,
		s_data->frame_seq_no, req->flags, req->ctx_link_update,
		stream_id, feature);
	...
	if (ctx->used_raw_num) {
		...
		if (!raw_dev)
			dev_info(cam->dev, "%s: raw_dev is null\n", __func__);
		if (mtk_cam_is_time_shared(ctx)) {
			...
			if (mtk_cam_is_mstream(ctx)) {
				...
				mstream_2nd_data = mtk_cam_req_get_s_data(
					req, stream_id, 0);
				if (mstream_2nd_data->seninf_new) {
					s_data->sensor =
						mstream_2nd_data->sensor;
					s_data->seninf_new =
						mstream_2nd_data->seninf_new;
					s_data->seninf_old =
						mstream_2nd_data->seninf_old;
				}
			}
			// stream_on(raw_dev, 0);
			dev_info(ctx->cam->dev, "%s: Disable cammux: %s\n",
				 __func__, s_data->seninf_old->name);
	...
	if (mtk_cam_is_stagger(ctx) || mtk_cam_hw_is_dc(ctx)) {
		...
		for (i = MTKCAM_SUBDEV_CAMSV_START; i < MTKCAM_SUBDEV_CAMSV_END;
			...
			if (ctx->pipe->enabled_raw & (1 << i)) {
				mtk_cam_sv_dev_stream_on(
					ctx, i - MTKCAM_SUBDEV_CAMSV_START, 0,
					hw_scen);
	...
	for (i = 0; i < ctx->used_sv_num; i++) {
		...
		if (watchdog_scenario(ctx))
			mtk_ctx_watchdog_stop(
				ctx, sv_dev->id + MTKCAM_SUBDEV_CAMSV_START, 0);
	...
	for (i = 0; i < ctx->used_mraw_num; i++) {
		...
		if (watchdog_scenario(ctx))
			mtk_ctx_watchdog_stop(
				ctx, mraw_dev->id + MTKCAM_SUBDEV_MRAW_START,
				0);
		mtk_cam_mraw_vf_on(mraw_dev, 0);
			     ...
			     struct mtk_cam_request *req)
{
	...
	for (i = 0; i < cam->max_stream_num; i++) {
		if (req->pipe_used & (1 << i)) {
			...
			if (mtk_cam_is_ext_isp(ctx)) {
				req_stream_data->state.estate =
					E_STATE_EXTISP_READY;
			}
			/*sensor setting after request drained check*/
			if (ctx->used_raw_num) {
				drained_seq_no = atomic_read(
					&sensor_ctrl->last_drained_seq_no);
				dev_dbg(cam->dev,
					"%s: feature pending(0x%x) active(0x%x)\n",
					__func__, ctx->pipe->feature_pending,
			...
			for (j = 0; j < MTKCAM_SUBDEV_MAX; j++) {
				if ((1 << j & ctx->streaming_pipe) &&
				    (1 << j & req->pipe_used)) {
					pipe_stream_data =
						mtk_cam_req_get_s_data(req, j,
								       0);
					done_work = &pipe_stream_data
							     ->frame_done_work;
					INIT_WORK(&done_work->work,
						  mtk_cam_frame_done_work);
					...
					INIT_WORK(&done_work->work,
						  mtk_cam_meta1_done_work);
				}
			}

			if (!immediate_switch_sensor && ctx->sensor &&
			    (initial_frame || mtk_cam_is_m2m(ctx))) {
				if (mtk_cam_is_mstream(ctx) ||
				    mtk_cam_is_mstream_m2m(ctx)) {
					mtk_cam_mstream_initial_sensor_setup(
						req, ctx);
			...
			if (mtk_cam_is_mstream(ctx)) {
				...
				handle_immediate_switch(ctx, req_stream_data,
							i);
			}
			...
			if (mtk_cam_is_mstream(ctx) ||
				...
				for (frame_cnt = 1;
				     frame_cnt <= MTKCAM_MSTREAM_MAX;
				     frame_cnt++) {
					if (frame_cnt == 1) { // first exposure
						dev_dbg(cam->dev,
							"%s: mstream 1st exp frame\n",
							__func__);
						req_stream_data =
							mtk_cam_req_get_s_data(
								req, stream_id,
					...
					frame_work =
						&req_stream_data->frame_work;
					mtk_cam_req_dump_work_init(
						req_stream_data);
...
{
	struct mtk_cam_ctx *ctx =
		container_of(work, struct mtk_cam_ctx, session_work);
...
static void isp_composer_hw_config(struct mtk_cam_device *cam,
				   struct mtk_cam_ctx *ctx,
				   struct mtkcam_ipi_config_param *config_param)
{
	struct mtkcam_ipi_event event;
			    ...
			    struct mtkcam_ipi_input_param *cfg_in_param)
{
	...
	if (ret < 0) {
		dev_info(raw->cam_dev, "failed at pm_runtime_get_sync: %s\n",
	...
	if (ctx->seninf)
		dev_info(raw->cam_dev,
			 "ctx_id %d seninf:%s used_raw_dev 0x%x pipe_id %d\n",
			 ctx->stream_id, ctx->seninf->name, ctx->used_raw_dev,
			 pipe->id);
	else
		dev_info(raw->cam_dev,
			 "ctx_id %d used_raw_dev 0x%x pipe_id %d\n",
				   ...
				   struct mtkcam_ipi_input_param *cfg_in_param)
{
	...
	s_raw_pipe_data->enabled_raw |=
		s_raw_pipe_data->stagger_select.enabled_raw;
	if (ctx->seninf)
		dev_info(raw->cam_dev,
			 "ctx_id %d seninf:%s used_raw_dev 0x%x pipe_id %d\n",
			 ctx->stream_id, ctx->seninf->name, ctx->used_raw_dev,
		...
		dev_info(raw->cam_dev,
			 "ctx_id %d used_raw_dev 0x%x pipe_id %d\n",
			 ctx->stream_id, s_raw_pipe_data->enabled_raw,
			 pipe->id);
			      ...
			      bool streaming, bool config_pipe)
{
	...
	cfg_in_param->subsample =
		mtk_cam_get_subsample_ratio(ctx->pipe->feature_active);
	...
	s_raw_pipe_data->enabled_raw =
		ctx->pipe->enabled_raw & MTKCAM_SUBDEV_RAW_MASK;
	...
	if (config_pipe && mtk_cam_feature_is_stagger(feature)) {
		...
		for (i = MTKCAM_SUBDEV_RAW_START; i < MTKCAM_SUBDEV_RAW_END;
		     i++) {
		...
		if (s_raw_pipe_data->stagger_select.hw_mode ==
		    HW_MODE_ON_THE_FLY) {
			hw_scen =
				(1
				 << MTKCAM_IPI_HW_PATH_ON_THE_FLY_DCIF_STAGGER);
			req_amount = (mtk_cam_feature_is_3_exposure(feature)) ?
					     2 :
					     1;
		} else if (s_raw_pipe_data->stagger_select.hw_mode ==
			   HW_MODE_DIRECT_COUPLED) {
			hw_scen =
				(1
				 << MTKCAM_IPI_HW_PATH_OFFLINE_SRT_DCIF_STAGGER);
			req_amount = (mtk_cam_feature_is_3_exposure(feature)) ?
		...
		idle_pipes = get_available_sv_pipes(cam, hw_scen, req_amount,
						    master, 0);
		...
		dev_info(
			cam->dev,
			"ctx->pipe->enabled_raw %d s_raw_pipe_data->enabled_raw %d",
			ctx->pipe->enabled_raw, s_raw_pipe_data->enabled_raw);
		if (idle_pipes == 0) {
			dev_info(cam->dev,
				 "no available sv pipes(scen:%d/req_amount:%d)",
				 hw_scen, req_amount);
			return -EINVAL;
		}
		...
		idle_pipes = get_available_sv_pipes(cam, hw_scen, req_amount,
						    master, 0);
		dev_info(cam->dev, "%s: dc mode idle_pipes %x", __func__,
			 idle_pipes);
		/* cached used sv pipes */
		s_raw_pipe_data->enabled_raw |= idle_pipes;
		ctx->pipe->enabled_raw |= idle_pipes;
	...
	if (mtk_cam_feature_is_mstream(feature) ||
		...
		dev_dbg(dev, "%s sw_feature:%d", __func__,
			config_param.sw_feature);
	} else {
		config_param.sw_feature =
			(mtk_cam_feature_is_stagger(feature) == 1 ||
			 mtk_cam_feature_is_stagger_m2m(feature) == 1) ?
				MTKCAM_IPI_SW_FEATURE_VHDR_STAGGER :
				MTKCAM_IPI_SW_FEATURE_NORMAL;
	}
	...
	for (i = 0; i < RAW_PIPELINE_NUM; i++)
		if (raw->pipelines[i].enabled_raw & 1 << raw_dev->id) {
			...
			if (raw->pipelines[i].res_config.raw_num_used != 1) {
				...
				if (raw->pipelines[i].res_config.raw_num_used ==
				    3) {
					struct mtk_raw_device *raw_dev_slave2 =
						get_slave2_raw_dev(cam,
								   ctx->pipe);
	...
	for (i = MTKCAM_SUBDEV_CAMSV_START; i < MTKCAM_SUBDEV_CAMSV_END; i++) {
		...
		if (used_pipes & (1 << i)) {
			ret = mtk_cam_sv_dev_config(
				...
				tgo_pxl_mode);
			if (ret) {
				dev_info(cam->dev, "%s failed(pipe:%d)",
					 __func__, i);
				return ret;
			}
		}
...
int mtk_cam_dev_config(struct mtk_cam_ctx *ctx, bool streaming,
		       bool config_pipe)
{
	struct mtk_cam_device *cam = ctx->cam;
	struct device *dev = cam->dev;
	...
	if (mtk_cam_is_pure_m2m(ctx)) {
		...
		dev_dbg(dev,
			"[pure m2m] rawi2 pad code:0x%x, sink tg size:%d %d\n",
			mf->code, cfg_in_param->in_crop.s.w,
	...
	if (config_pipe && mtk_cam_feature_is_stagger(feature_active)) {
		...
		if (mtk_cam_hw_is_otf(ctx)) {
			hw_scen =
				(1
				 << MTKCAM_IPI_HW_PATH_ON_THE_FLY_DCIF_STAGGER);
			req_amount = (mtk_cam_feature_is_3_exposure(
					     feature_active)) ?
					     2 :
					     1;
		...
		hw_scen = (1 << MTKCAM_IPI_HW_PATH_OFFLINE_STAGGER);
		req_amount =
			(mtk_cam_feature_is_3_exposure(feature_active)) ? 3 : 2;
		...
		if (ctx->ext_isp_meta_off || ctx->ext_isp_pureraw_off) {
			ctx->pipe->enabled_raw &= ~idle_pipes;
			if (ctx->ext_isp_meta_off && ctx->ext_isp_pureraw_off) {
				idle_pipes = idle_pipes &
					     (~(1 << MTKCAM_SUBDEV_CAMSV_1));
				idle_pipes = idle_pipes &
					     (~(1 << MTKCAM_SUBDEV_CAMSV_0));
				ctx->cam->sv
					.pipelines[MTKCAM_SUBDEV_CAMSV_0 -
						   MTKCAM_SUBDEV_CAMSV_START]
					.is_occupied = 0;
				ctx->cam->sv
					.pipelines[MTKCAM_SUBDEV_CAMSV_1 -
						   MTKCAM_SUBDEV_CAMSV_START]
					.is_occupied = 0;
			...
			ctx->pipe->enabled_raw |= idle_pipes;
			dev_info(cam->dev,
				 "force debug enable raw (0x%x) sv pipes(0x%x)",
				 ctx->pipe->enabled_raw, idle_pipes);
		}
	}

	update_hw_mapping(ctx, &config_param, feature_active,
			  ctx->pipe->hw_mode, ctx->pipe->enabled_raw);
	if (mtk_cam_feature_is_mstream(feature_active) ||
		...
		config_param.sw_feature =
			(mtk_cam_feature_is_stagger(feature_active) == 1 ||
...
{
	unsigned int ipi_id =
		CCD_IPI_ISP_MAIN + pipe_id - MTKCAM_SUBDEV_RAW_START;
...
static int isp_composer_init(struct mtk_cam_ctx *ctx, unsigned int pipe_id)
{
	...
	ctx->rpmsg_dev->rpdev.ept = rpmsg_create_ept(
		&ctx->rpmsg_dev->rpdev, isp_composer_handler, cam, *msg);
...
static int mtk_cam_power_ctrl_ccu(struct device *dev, int on_off)
{
	...
	if (on_off) {
		...
		if (ret)
			goto out;
		cam_dev->rproc_ccu_handle =
			rproc_get_by_phandle(cam_dev->rproc_ccu_phandle);
		...
		if (dvfs_info->reg_vmm) {
			...
			if (ret)
				dev_info(dev, "enable reg_vmm fail:%d\n", ret);
		}
	} else {
		if (dvfs_info->reg_vmm &&
		    regulator_is_enabled(dvfs_info->reg_vmm))
				      ...
				      struct mtk_cam_video_device *node)
{
	...
	ctx->sensor_worker_task =
		kthread_run(kthread_worker_fn, &ctx->sensor_worker,
			    "sensor_worker-%d", ctx->stream_id);
...
void mtk_cam_stop_ctx(struct mtk_cam_ctx *ctx, struct media_entity *entity)
{
	...
	for (i = 0; i < ctx->used_sv_num; i++) {
		for (j = 0; j < cam->max_stream_num; j++) {
			if (ctx->sv_pipe[i]->id == cam->ctxs[j].stream_id) {
				atomic_set(&cam->ctxs[j].enqueued_frame_seq_no,
					   0);
				break;
			}
		}
	...
	if (ctx->pipe) {
		...
		memset(&ctx->pipe->pde_config, 0,
		       sizeof(ctx->pipe->pde_config));
	}
	...
	dev_info(cam->dev, "%s: ctx-%d:  composer_cnt:%d\n", __func__,
		 ctx->stream_id, cam->composer_cnt);
...
int mtk_cam_call_seninf_set_pixelmode(struct mtk_cam_ctx *ctx,
				      struct v4l2_subdev *sd, int pad_id,
				      int pixel_mode)
{
	int ret;
	...
	dev_dbg(ctx->cam->dev,
		...
		__func__, ctx->stream_id, sd->name, pad_id, pixel_mode, ret);
...
int mtk_cam_ctx_stream_on(struct mtk_cam_ctx *ctx)
{
	...
	for (i = 0; i < MAX_PIPES_PER_STREAM && ctx->pipe_subdevs[i]; i++) {
		ret = v4l2_subdev_call(ctx->pipe_subdevs[i], video, s_stream,
				       1);
		if (ret) {
	...
	if (ctx->used_raw_num) {
		...
		buf_size = ctx->pipe
				   ->vdev_nodes[MTK_RAW_MAIN_STREAM_OUT -
						MTK_RAW_SINK_NUM]
				   .active_fmt.fmt.pix_mp.plane_fmt[0]
				   .sizeimage;
		...
		if (ctx->pipe->dynamic_exposure_num_max > 1 ||
			...
			buf_require = max(buf_require,
					  2 + mtk_cam_feature_is_3_exposure(
						      feature_active));
		}
		if (mtk_cam_is_ext_isp(ctx))
		...
		if (mtk_cam_hw_is_dc(ctx)) {
			buf_require = max(buf_require,
					  4); //worst case, 2exp: 2camsv+2rawi
			buf_size = ctx->pipe
					   ->vdev_nodes[MTK_RAW_SINK -
							MTK_RAW_SINK_BEGIN]
					   .sink_fmt_for_dc_rawi.fmt.pix_mp
					   .plane_fmt[0]
					   .sizeimage;
		...
		if (buf_require)
			ret = mtk_cam_img_working_buf_pool_init(
				ctx, buf_require, buf_size);
		...
		if (mtk_cam_is_ext_isp(ctx)) {
			...
			if (mtk_cam_extisp_prepare_meta(ctx, PAD_SRC_RAW0) ==
			    0) {
				ctx->ext_isp_pureraw_off = 1;
				dev_info(
					ctx->cam->dev,
					"[%s] no pureraw: debug_preisp_off_dara:%d, 0/1/2 = %d/%d/%d\n",
			...
			dev_info(
				ctx->cam->dev,
				"[%s] debug_preisp_off_dara:%d, 0/1/2 = %d/%d/%d\n",
				__func__, debug_preisp_off_data,
				ctx->ext_isp_meta_off, ctx->ext_isp_pureraw_off,
				ctx->ext_isp_procraw_off);
		}
		...
		if (mtk_cam_feature_is_stagger(feature_active)) {
			...
			for (i = MTKCAM_SUBDEV_CAMSV_START;
				...
				if (used_pipes & (1 << i)) {
					...
					mtk_cam_call_seninf_set_pixelmode(
						ctx, ctx->seninf, src_pad_idx,
						tgo_pxl_mode);
					mtk_cam_seninf_set_camtg(
			...
			for (i = MTKCAM_SUBDEV_CAMSV_START;
				...
				if (ctx->pipe->enabled_raw & 1 << i) {
					int hw_scen =
						(1
						 << MTKCAM_SV_SPECIAL_SCENARIO_ADDITIONAL_RAW);

					mtk_cam_call_seninf_set_pixelmode(
						ctx, ctx->seninf,
						PAD_SRC_RAW_W0, tgo_pxl_mode);
					mtk_cam_seninf_set_camtg(
						ctx->seninf, PAD_SRC_RAW_W0,
						cam->sv.pipelines
							[i -
							 MTKCAM_SUBDEV_CAMSV_START]
								.cammux_id);
			...
			used_pipes = ctx->pipe->enabled_raw;
			raw_idx = get_master_raw_id(cam->num_raw_drivers,
						    used_pipes);
			...
			for (i = MTKCAM_SUBDEV_CAMSV_START;
				...
				if (used_pipes & (1 << i)) {
					...
					dev_info(
						cam->dev,
						"[EXTISP] scen:0x%x/enabled_raw:0x%x/i(%d)",
						hw_scen, ctx->pipe->enabled_raw,
						i);
				}
			}
		...
		if (mtk_cam_feature_is_stagger(feature_active)) {
			if (mtk_cam_hw_is_otf(ctx)) {
				...
				if (mtk_cam_feature_is_2_exposure(
					    feature_first_req))
			...
			if (mtk_cam_is_ext_isp_yuv(ctx)) {
				dev_info(
					cam->dev,
					"[PreISP] YUV pipeline enabled_raw:0x%x\n",
					ctx->pipe->enabled_raw);
			} else {
				/* todo: backend support one pixel mode only */
				mtk_cam_seninf_set_pixelmode(
					ctx->seninf, PAD_SRC_RAW_EXT0,
...
#endif
			mtk_cam_call_seninf_set_pixelmode(
				ctx, ctx->seninf, PAD_SRC_RAW0, tgo_pxl_mode);
	...
	if (!mtk_cam_feature_is_m2m(feature_active)) {
		...
		for (i = 0; i < ctx->used_mraw_num; i++) {
			...
			mtk_cam_seninf_set_camtg(
				ctx->seninf, ctx->mraw_pipe[i]->seninf_padidx,
				ctx->mraw_pipe[i]->cammux_id);

			dev_dbg(cam->dev,
				"Set mraw pad(%d) to pixel_mode(%d)\n",
				      ...
				      struct mtk_cam_ctx *ctx)
{
	...
	for (i = 0; i < cam->max_stream_num; i++) {
		...
		if (ctx_chk->pipe) {
			...
			dev_info(
				cam->dev,
				"[%s] i:%d pipe/ts:%d/0x%x chk_pipe/ts:%d/0x%x\n",
				__func__, i, pipe->id, ts_id, pipe_chk->id,
				ts_id_chk);
			if (ts_id == ts_id_chk) {
...
int mtk_cam_ctx_stream_off(struct mtk_cam_ctx *ctx)
{
	...
	dev_info(cam->dev,
		 "%s: ctx-%d:  composer_cnt:%d, streaming_pipe:0x%x\n",
	...
	if (ctx->used_raw_num) {
		if (ctx->pipe->enabled_raw & MTKCAM_SUBDEV_RAW_MASK)
			ret = v4l2_subdev_call(&ctx->pipe->subdev, video,
					       s_stream, 0);
	}

	for (i = 0; i < MAX_SV_PIPES_PER_STREAM && ctx->sv_pipe[i]; i++) {
		ret = v4l2_subdev_call(&ctx->sv_pipe[i]->subdev, video,
				       s_stream, 0);
	}
	...
	for (i = 0; i < MAX_MRAW_PIPES_PER_STREAM && ctx->mraw_pipe[i]; i++) {
		ret = v4l2_subdev_call(&ctx->mraw_pipe[i]->subdev, video,
				       s_stream, 0);
	}
				   ...
				   struct v4l2_subdev *seninf)
{
	...
	for (i = 0; i < cam->max_stream_num; i++) {
		if (i >= MTKCAM_SUBDEV_RAW_START &&
		...
		} else if (i >= MTKCAM_SUBDEV_CAMSV_START &&
			   i < MTKCAM_SUBDEV_CAMSV_END) {
			pipe_entity =
				&cam->sv.pipelines[i - MTKCAM_SUBDEV_CAMSV_START]
					 .subdev.entity;
			...
			for (j = PAD_SRC_PDAF0; j <= PAD_SRC_PDAF5; j++) {
				ret = media_create_pad_link(
					&seninf->entity, j, pipe_entity,
					MTK_CAMSV_SINK, MEDIA_LNK_FL_DYNAMIC);

				if (ret) {
					dev_dbg(cam->dev,
						"failed to create pad link %s %s err:%d\n",
						seninf->entity.name,
						pipe_entity->name, ret);
					return ret;
				}
			}
#endif
		} else if (i >= MTKCAM_SUBDEV_MRAW_START &&
			   i < MTKCAM_SUBDEV_MRAW_END) {
			pipe_entity =
				&cam->mraw
					 .pipelines[i - MTKCAM_SUBDEV_MRAW_START]
					 .subdev.entity;
			...
			for (j = PAD_SRC_PDAF0; j <= PAD_SRC_PDAF5; j++) {
				ret = media_create_pad_link(
					&seninf->entity, j, pipe_entity,
					MTK_MRAW_SINK, MEDIA_LNK_FL_DYNAMIC);
...
static struct component_match *mtk_cam_match_add(struct device *dev)
{
	...
	dev_info(dev, "#: raw %d, yuv %d, larb %d, sv %d, seninf %d, mraw %d\n",
		 cam_dev->num_raw_drivers, yuv_num, cam_dev->num_larb_drivers,
		 cam_dev->num_camsv_drivers, cam_dev->num_seninf_drivers,
		 cam_dev->num_mraw_drivers);
...
static void mtk_cam_ctx_watchdog_worker(struct work_struct *work)
{
	...
	timeout = mtk_cam_seninf_check_timeout(
		seninf, watchdog_data->watchdog_time_diff_ns);
	...
	if (is_raw_subdev(pipe_id)) {
		...
		if (dev == NULL) {
			dev_info(
				ctx->cam->dev,
				"%s:ctx/pipe_id(%d/%d):config camsv device not found\n",
				__func__, ctx->stream_id, pipe_id);
			complete(&watchdog_data->watchdog_complete);
			return;
		}
		camsv_dev = dev_get_drvdata(dev);
		dequeued_frame_seq_no = readl_relaxed(camsv_dev->base_inner +
						      REG_CAMSV_FRAME_SEQ_NO);
		...
		if (dev == NULL) {
			dev_info(
				ctx->cam->dev,
				"%s:ctx/pipe_id(%d/%d):config mraw device not found\n",
				__func__, ctx->stream_id, pipe_id);
			complete(&watchdog_data->watchdog_complete);
			return;
		}
		mraw_dev = dev_get_drvdata(dev);
		dequeued_frame_seq_no = readl_relaxed(mraw_dev->base_inner +
						      REG_MRAW_FRAME_SEQ_NUM);
		...
		if (timeout) {
			if (is_raw_subdev(pipe_id)) {
				dev_info(
					...
					__func__, ctx->stream_id, pipe_id,
					vf_en, raw->vsync_count, sof_count,
					raw->overrun_debug_dump_cnt,
					watchdog_cnt,
			...
			if (mtk_cam_seninf_dump(seninf, dequeued_frame_seq_no,
				...
				mtk_cam_event_esd_recovery(
					ctx->pipe, ctx->dequeued_frame_seq_no);
...
static void mtk_ctx_watchdog(struct timer_list *t)
{
	...
	if (atomic_read(&raw->vf_en) == 0 && !mtk_cam_is_ext_isp(ctx)) {
		dev_info(ctx->cam->dev, "%s:ctx(%d):vf_en = 0\n", __func__,
			 ctx->stream_id);
		return;
	}
	...
	for (i = MTKCAM_SUBDEV_RAW_START; i < MTKCAM_SUBDEV_MAX; i++) {
		if (enabled_watchdog_pipe & (1 << i)) {
			...
			watchdog_cnt =
				atomic_inc_return(&watchdog_data->watchdog_cnt);
			watchdog_dump_cnt =
				atomic_read(&watchdog_data->watchdog_dump_cnt);
			if (is_raw_subdev(i)) {
				watchdog_data->watchdog_time_diff_ns =
				...
				idx = watchdog_data->pipe_id -
				      MTKCAM_SUBDEV_CAMSV_START;
				dev = cam->sv.devs[idx];
				if (dev == NULL) {
					dev_info(
						ctx->cam->dev,
						"%s:ctx/pipe_id(%d/%d):config camsv %d device not found\n",
				...
				if (dev == NULL) {
					dev_info(
						ctx->cam->dev,
						"%s:ctx/pipe_id(%d/%d):config mraw %d device not found\n",
						__func__, ctx->stream_id, i,
						idx);
					goto GET_DEV_FAILED;
				}
			...
			if (atomic_read(&watchdog_data->watchdog_dumped)) {
				...
				if (watchdog_dump_cnt < 4) {
					dev_info_ratelimited(
						ctx->cam->dev,
						"%s:ctx/pipe_id(%d/%d): timeout! VF(%d) raw vsync count(%d) sof count(%d) watchdog_cnt(%d)(+%llddms)\n",
						__func__, ctx->stream_id, i,
						is_vf_on, raw->vsync_count,
						sof_count, watchdog_cnt,
						watchdog_data->watchdog_time_diff_ns /
							1000000);
					schedule_work(
						&watchdog_data->watchdog_work);
				} else {
					dev_info_ratelimited(
						ctx->cam->dev,
						"%s:ctx/pipe_id(%d/%d): dump > 3! watchdog_dump_cnt(%d)(+%lldms)\n",
						__func__, ctx->stream_id, i,
						watchdog_dump_cnt,
						watchdog_data->watchdog_time_diff_ns /
							1000000);
...
void mtk_ctx_watchdog_kick(struct mtk_cam_ctx *ctx, int pipe_id)
{
	...
	if (!(enabled_watchdog_pipe & (1 << pipe_id))) {
		dev_info_ratelimited(
			ctx->cam->dev,
			"%s:ctx/pipe_id(%d/%d): kick target is not enabled\n",
			__func__, ctx->stream_id, pipe_id);
		return;
	}
			   ...
			   int ctx_streamoff)
{
	...
	if (wait_for_completion_timeout(&watchdog_data->watchdog_complete,
		...
		dev_info(ctx->cam->dev, "%s:ctx/pipe_id(%d/%d): complete\n",
			 __func__, ctx->stream_id, pipe_id);
...
static void mtk_cam_ctx_init(struct mtk_cam_ctx *ctx,
			     struct mtk_cam_device *cam, unsigned int stream_id)
{
	unsigned int i;
...
static int mtk_cam_v4l2_subdev_link_validate(
	struct v4l2_subdev *sd, struct media_link *link,
	struct v4l2_subdev_format *source_fmt,
	struct v4l2_subdev_format *sink_fmt, bool bypass_size_check)
{
	bool pass = true;
	...
	if (source_fmt->format.width != sink_fmt->format.width) {
		dev_dbg(sd->entity.graph_obj.mdev->dev,
			...
			__func__, source_fmt->format.width,
	...
	if (source_fmt->format.height != sink_fmt->format.height) {
		dev_dbg(sd->entity.graph_obj.mdev->dev,
			...
			__func__, source_fmt->format.height,
	...
	if (source_fmt->format.code != sink_fmt->format.code) {
		dev_info(
			...
			__func__, source_fmt->format.code,
...
int mtk_cam_link_validate(struct v4l2_subdev *sd, struct media_link *link,
			  struct v4l2_subdev_format *source_fmt,
...
int mtk_cam_sv_link_validate(struct v4l2_subdev *sd, struct media_link *link,
			     struct v4l2_subdev_format *source_fmt,
			     struct v4l2_subdev_format *sink_fmt)
{
	struct device *dev;
...
int mtk_cam_mraw_link_validate(struct v4l2_subdev *sd, struct media_link *link,
			       struct v4l2_subdev_format *source_fmt,
			       struct v4l2_subdev_format *sink_fmt)
{
	struct device *dev;
...
static int mtk_cam_debug_fs_init(struct mtk_cam_device *cam)
{
	...
	cam->debug_wq = alloc_ordered_workqueue(dev_name(cam->dev),
						__WQ_LEGACY | WQ_MEM_RECLAIM |
							WQ_FREEZABLE);
	cam->debug_exception_wq = alloc_ordered_workqueue(
		dev_name(cam->dev),
...
static int mtk_cam_probe(struct platform_device *pdev)
{
	...
	cam_dev->link_change_wq = alloc_ordered_workqueue(
		dev_name(cam_dev->dev), WQ_HIGHPRI | WQ_FREEZABLE);
...
static const struct dev_pm_ops mtk_cam_pm_ops = { SET_RUNTIME_PM_OPS(
	mtk_cam_runtime_suspend, mtk_cam_runtime_resume, NULL) };

static struct platform_driver
	mtk_cam_driver = { .probe = mtk_cam_probe,
			   .remove = mtk_cam_remove,
			   .driver = {
				   .name = "mtk-cam",
				   .of_match_table =
					   of_match_ptr(mtk_cam_of_ids),
				   .pm = &mtk_cam_pm_ops,
			   } };

static void __maybe_unused
media_device_setup_link_hook(void *data, struct media_link *link,
			     struct media_link_desc *linkd, int *ret)
{
	int ret_value;

	pr_debug("%s req_fd:%d\n", __func__, linkd->reserved[0]);
	atomic_set(&mtk_cam_media_link_request_fd, linkd->reserved[0]);
	ret_value = __media_entity_setup_link(link, linkd->flags);
	atomic_set(&mtk_cam_media_link_request_fd, -1);
	*ret = (ret_value < 0) ? ret_value : 1;
	pr_debug("%s ret:%d\n", __func__, *ret);
}

static void __maybe_unused clear_reserved_fmt_fields_hook(void *data,
...
static void __maybe_unused fill_ext_fmtdesc_hook(void *data,
...
static void __maybe_unused clear_mask_adjust_hook(void *data, unsigned int ctrl,
						  int *n)
{
...
static void __maybe_unused v4l2subdev_set_fmt_hook(
	void *data, struct v4l2_subdev *sd, struct v4l2_subdev_pad_config *pad,
...
static void __maybe_unused v4l2subdev_set_selection_hook(
	void *data, struct v4l2_subdev *sd, struct v4l2_subdev_pad_config *pad,
...
static void __maybe_unused v4l2subdev_set_frame_interval_hook(
	void *data, struct v4l2_subdev *sd,
	struct v4l2_subdev_frame_interval *fi, int *ret)
{
	int retval = 0;
...
static void mtk_cam_trace_init(void)
{
	...
	ret = register_trace_android_vh_fill_ext_fmtdesc(fill_ext_fmtdesc_hook,
							 NULL);
	if (ret)
