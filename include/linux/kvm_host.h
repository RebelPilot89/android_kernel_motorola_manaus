...
#define KVM_REQ_VM_DEAD KVM_REQ_VM_BUGGED
#define KVM_REQ_UNBLOCK KVM_REQ_UNHALT
#define KVM_REQ_RELOAD_GUEST_PGTE (5 | KVM_REQUEST_WAIT | KVM_REQUEST_NO_WAKEUP)
...
#define mmu_invalidate_seq mmu_notifier_seq
#define mn_active_invalidate_count mmu_notifier_count
...
#define __kvm_get_guest(kvm, gfn, offset, v)                                   \
	({                                                                     \
		...
		typeof(v) __user *__uaddr =                                    \
			(typeof(__uaddr))(__addr + offset);                    \
		int __ret = -EFAULT;                                           \
                                                                               \
...
static inline void kvm_vcpu_halt(struct kvm_vcpu *vcpu)
{
	kvm_vcpu_block(vcpu);
}
