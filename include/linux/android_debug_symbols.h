...
void android_debug_for_each_module(int (*fn)(const char *mod_name,
...
static inline void *
android_debug_per_cpu_symbol(enum android_debug_per_cpu_symbol symbol)
{
	return NULL;
}

static inline void android_debug_for_each_module(
	int (*fn)(const char *mod_name, void *mod_addr, void *data), void *data)
{
}
