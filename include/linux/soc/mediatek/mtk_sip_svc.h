...
#define MTK_SIP_KERNEL_GIC_DUMP MTK_SIP_SMC_CMD(0x201)
...
#define MTK_SIP_KERNEL_DAPC_MMUP_GET MTK_SIP_SMC_CMD(0x533)
...
#define MTK_SIP_APUPWR_CONTROL MTK_SIP_SMC_CMD(0x526)
...
/* PKVM PRINT */
#define MTK_SIP_HYP_PKVM_CONTROL MTK_SIP_SMC_CMD(0x834)
