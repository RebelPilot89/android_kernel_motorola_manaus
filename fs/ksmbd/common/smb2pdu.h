...
#define SMB2_HEADER_STRUCTURE_SIZE cpu_to_le16(__SMB2_HEADER_STRUCTURE_SIZE)
...
struct smb2_close_rsp {
	...
	__le16 Flags;
	__le32 Reserved;
	struct_group_attr(network_open_info, __packed, __le64 CreationTime;
			  __le64 LastAccessTime; __le64 LastWriteTime;
			  __le64 ChangeTime;
...
#define FILE_READ_DESIRED_ACCESS_LE                                            \
	(FILE_READ_DATA_LE | FILE_READ_EA_LE | FILE_GENERIC_READ_LE)
#define FILE_WRITE_DESIRE_ACCESS_LE                                            \
	(FILE_WRITE_DATA_LE | FILE_APPEND_DATA_LE | FILE_WRITE_EA_LE |         \
...
#define FILE_READ_RIGHTS_LE                                                    \
	(FILE_READ_DATA_LE | FILE_READ_EA_LE | FILE_READ_ATTRIBUTES_LE)
