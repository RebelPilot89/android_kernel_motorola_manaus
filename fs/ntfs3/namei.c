		       ...
		       bool excl)
{
	...
	inode = ntfs_create_inode(dir, dentry, NULL, S_IFREG | mode, 0, NULL, 0,
				  NULL);
		      ...
		      dev_t dev)
{
	...
	inode = ntfs_create_inode(dir, dentry, NULL, mode, dev, NULL, 0, NULL);
			...
			const char *symname)
{
	...
	inode = ntfs_create_inode(dir, dentry, NULL, S_IFLNK | 0777, 0, symname,
				  size, NULL);
...
static int ntfs_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	inode = ntfs_create_inode(dir, dentry, NULL, S_IFDIR | mode, 0, NULL, 0,
				  NULL);
