 ...
 * fatal.
 */
asmlinkage void notrace bad_mode(struct pt_regs *regs, int reason,
				 unsigned int esr)
{
...
static int reserved_fault_handler(struct pt_regs *regs, unsigned int esr)
{
	pr_err("%s generated an invalid instruction at %pS!\n",
	       "Kernel text patching", (void *)instruction_pointer(regs));
