...
#define ARM64_CPUCAP_SCOPE_MASK                                                \
	(ARM64_CPUCAP_SCOPE_SYSTEM | ARM64_CPUCAP_SCOPE_LOCAL_CPU |            \
...
static inline bool id_aa64mmfr0_mixed_endian_el0(u64 mmfr0)
{
	return cpuid_feature_extract_unsigned_field(
		       mmfr0, ID_AA64MMFR0_BIGENDEL_SHIFT) == 0x1 ||
	       cpuid_feature_extract_unsigned_field(
		       mmfr0, ID_AA64MMFR0_BIGENDEL0_SHIFT) == 0x1;
}
...
static inline bool supports_clearbhb(int scope)
{
	...
	return cpuid_feature_extract_unsigned_field(
		isar2, ID_AA64ISAR2_CLEARBHB_SHIFT);
}
...
{
	return id_aa64mmfr0_mixed_endian_el0(
...
{
	return IS_ENABLED(CONFIG_ARM64_SVE) && cpus_have_const_cap(ARM64_SVE);
}
...
{
	return IS_ENABLED(CONFIG_ARM64_MTE) && cpus_have_const_cap(ARM64_MTE);
}
...
static inline unsigned int get_vmid_bits(u64 mmfr1)
{
	...
	vmid_bits = cpuid_feature_extract_unsigned_field(
		mmfr1, ID_AA64MMFR1_VMIDBITS_SHIFT);
