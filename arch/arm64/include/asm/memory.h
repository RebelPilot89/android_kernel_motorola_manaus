 ...
 */
#define VMEMMAP_SIZE                                                           \
	((_PAGE_END(VA_BITS_MIN) - PAGE_OFFSET) >>                             \
...
#define KASAN_SHADOW_END                                                       \
	((UL(1) << (64 - KASAN_SHADOW_SCALE_SHIFT)) + KASAN_SHADOW_OFFSET)
...
#define MT_S2_NORMAL_NC MT_S2_NORMAL
...
#define MT_S2_FWB_NORMAL_NC MT_S2_FWB_NORMAL
...
#define page_to_virt(x)                                                        \
	({                                                                     \
		...
		(void *)__tag_set((const void *)__addr,                        \
				  page_kasan_tag(__page));                     \
	})
...
#define page_to_virt(x)                                                        \
	({                                                                     \
		__typeof__(x) __page = x;                                      \
		u64 __idx =                                                    \
			((u64)__page - VMEMMAP_START) / sizeof(struct page);   \
