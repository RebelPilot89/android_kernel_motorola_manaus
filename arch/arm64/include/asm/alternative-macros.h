...
#ifndef ARM64_CB_SHIFT
#define ARM64_CB_SHIFT 15
#endif

#ifndef ARM64_ALWAYS_SYSTEM
#define ARM64_ALWAYS_SYSTEM ARM64_NCAPS
#endif
...
.macro alternative_cb cap, cb=
	...
	.pushsection .altinstructions, "a"
	.ifb \cb
		/* One-arg form: treat \cap as callback, use default CB capability */
		altinstruction_entry 661f, \cap, (1 << ARM64_CB_SHIFT) | ARM64_CB_PATCH, 662f-661f, 0
	.else
		/* Two-arg form: explicit capability + callback */
...
#define _ALTERNATIVE(oldinstr, feature, feature_str)                           \
	__take_second_arg(feature oldinstr,                                    \
			  ".err Feature " feature_str                          \
			  " not supported in fips140 module")
