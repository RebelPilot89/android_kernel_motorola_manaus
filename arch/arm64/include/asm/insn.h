...
/* Opcode base para STADD (LSE atómico sin retorno) */
#define AARCH64_INSN_STADD 0xb820001f
...
u32 aarch64_insn_gen_cas(enum aarch64_insn_register result,
			 ...
			 enum aarch64_insn_size_type size,
			 enum aarch64_insn_mem_order_type order);
/* UPDATED: Prototipo de STADD usando size (canónico) */
u32 aarch64_insn_gen_stadd(enum aarch64_insn_register rn,
			   enum aarch64_insn_register rs,
			   enum aarch64_insn_size_type size);
#else
static inline
u32 aarch64_insn_gen_atomic_ld_op(enum aarch64_insn_register result,
...
/* UPDATED: Stub para STADD usando size */
static inline
u32 aarch64_insn_gen_stadd(enum aarch64_insn_register rn,
			   enum aarch64_insn_register rs,
			   enum aarch64_insn_size_type size)
...
/* Escribir un literal de 64 bits en el flujo de instrucciones (para parches) */
