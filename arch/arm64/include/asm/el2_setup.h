...
/*
 * Donor EL2 finalize helper, stubbed as a no-op on this kernel base.
 */
...
/*
 * Donor feature-override check helper. On this base, unconditionally
 * branch to the failure label to avoid enabling unsupported features.
 */
.macro check_override idreg, fieldshift, ok, fail, tmp1, tmp2
	b \fail
.endm
