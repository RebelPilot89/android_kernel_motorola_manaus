...
#ifndef KVM_SYSTEM_EVENT_RESET_FLAG_PSCI_RESET2
#define KVM_SYSTEM_EVENT_RESET_FLAG_PSCI_RESET2 BIT(0)
#endif

#ifndef KVM_SYSTEM_EVENT_SUSPEND
#define KVM_SYSTEM_EVENT_SUSPEND KVM_SYSTEM_EVENT_WAKEUP
#endif
...
/* FW register accessors live in hypercalls.c */
