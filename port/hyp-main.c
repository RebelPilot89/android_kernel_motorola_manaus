 ...
 *
 * Merged with pKVM and tracing enhancements from hyp-main-donor.c.
 * Preserves hypercall ABI from donor, enabling protected VM support,
 * IOMMU, tracing, and advanced SMC forwarding.
 */
